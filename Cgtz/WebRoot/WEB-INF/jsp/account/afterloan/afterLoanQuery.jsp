...
<body>
<div class="easyui-tabs" id="afterLoanQueryTabs" data-options="fit:true">
	<div title="出纳贷后核帐列表">
		<div id="main">
			<div id="part1" class="part">
				...
				<div class="content">
					<form id="queryForm" action="account/afterloan/list.do" method="post" target="queryContent">
						<table>
							<tr>
								<td>合同编号:</td>
...
function addTab(title, url){
    if ($('#afterLoanQueryTabs').tabs('exists', title)){
        $('#afterLoanQueryTabs').tabs('select', title);
    } else {
        var content = '<iframe scrolling="auto" frameborder="0"  src="'+url+'" style="width:100%;height:100%;"></iframe>';
        $('#afterLoanQueryTabs').tabs('add',{
            title:title,
            content:content,
            closable:true
        });
...
//提交后，删除当前选项卡
function removeTab(){
	var tab = $('#afterLoanQueryTabs').tabs('getSelected');
	var tabIndex=$('#afterLoanQueryTabs').tabs('getTabIndex',tab);
	$('#afterLoanQueryTabs').tabs('close',tabIndex);
