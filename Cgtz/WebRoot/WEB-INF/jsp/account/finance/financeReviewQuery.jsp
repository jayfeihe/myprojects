...
<body>
<div class="easyui-tabs" id="cashQueryTabs" data-options="fit:true">
	<div title="财务复核列表">
		<div id="main">
			<div id="part1" class="part">
				...
				<div class="content">
					<form id="queryForm" action="account/financeReview/list.do" method="post" target="queryContent">
						<table>
							<tr>
								<td>申请编号:</td>
...
function addTab(title, url){
    if ($('#cashQueryTabs').tabs('exists', title)){
        $('#cashQueryTabs').tabs('select', title);
    } else {
        var content = '<iframe scrolling="auto" frameborder="0"  src="'+url+'" style="width:100%;height:100%;"></iframe>';
        $('#cashQueryTabs').tabs('add',{
            title:title,
            content:content,
            closable:true
        });
...
//提交后，删除当前选项卡
function removeTab(){
	var tab = $('#cashQueryTabs').tabs('getSelected');
	var tabIndex=$('#cashQueryTabs').tabs('getTabIndex',tab);
	$('#cashQueryTabs').tabs('close',tabIndex);
