...
<body>
<div class="easyui-tabs" id="offLineQueryTabs" data-options="fit:true">
	<div title="线下放款列表">
		<div id="main">
			<div id="part1" class="part">
				...
				<div class="content">
					<form id="queryForm" action="account/offline/list.do" method="post" target="queryContent">
						<table>
							<tr>
								<td>申请编号:</td>
...
function addTab(title, url){
    if ($('#offLineQueryTabs').tabs('exists', title)){
        $('#offLineQueryTabs').tabs('select', title);
    } else {
        var content = '<iframe scrolling="auto" frameborder="0"  src="'+url+'" style="width:100%;height:100%;"></iframe>';
        $('#offLineQueryTabs').tabs('add',{
            title:title,
            content:content,
            closable:true
        });
...
//提交后，删除当前选项卡
function removeTab(){
	var tab = $('#offLineQueryTabs').tabs('getSelected');
	var tabIndex=$('#offLineQueryTabs').tabs('getTabIndex',tab);
	$('#offLineQueryTabs').tabs('close',tabIndex);
