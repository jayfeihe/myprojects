...
<body>
<div class="easyui-tabs" id="payOutQueryTabs" data-options="fit:true">
	<div title="贷后垫付列表">
		<div id="main">
			<div id="part1" class="part">
				...
				<div class="content">
					<form id="queryForm" action="account/payout/list.do" method="post" target="queryContent">
						<table>
							<tr>
								<td>线下合同编号:</td>
...
function addTab(title, url){
    if ($('#payOutQueryTabs').tabs('exists', title)){
        $('#payOutQueryTabs').tabs('select', title);
    } else {
        var content = '<iframe scrolling="auto" frameborder="0"  src="'+url+'" style="width:100%;height:100%;"></iframe>';
        $('#payOutQueryTabs').tabs('add',{
            title:title,
            content:content,
            closable:true
        });
...
//提交后，删除当前选项卡
function removeTab(){
	var tab = $('#payOutQueryTabs').tabs('getSelected');
	var tabIndex=$('#payOutQueryTabs').tabs('getTabIndex',tab);
	$('#payOutQueryTabs').tabs('close',tabIndex);
