...
<body>
	...
	<div id="part1" class="part">
		<p class="title"><a href="javascript:void(0);">接口日志查询</a></p>
		
		<div class="content">
			<form id="queryForm" action="interfaceLog/list.do" method="post" target="queryContent">
				<table>

<tr>
<td>业务ID:</td>
<td><input id="bizKey" name="bizKey" type="text" data-options="validType:['length[0,200]']" class="textbox easyui-validatebox"/></td>
