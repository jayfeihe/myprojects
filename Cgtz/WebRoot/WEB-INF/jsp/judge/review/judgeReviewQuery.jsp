...
<body>
<div class="easyui-tabs" id="judgeFirstQueryTabs" data-options="fit:true">
	<div title="评审会复核列表">
		<div id="main">
			<div id="part1" class="part">
				...
				<div class="content">
					<form id="queryForm" action="judge/review/list.do" method="post" target="queryContent">
						<table>
							<tr>
								<td>申请编号:</td>
...
function addTab(title, url){
    if ($('#judgeFirstQueryTabs').tabs('exists', title)){
        $('#judgeFirstQueryTabs').tabs('select', title);
    } else {
        var content = '<iframe scrolling="auto" frameborder="0"  src="'+url+'" style="width:100%;height:100%;"></iframe>';
        $('#judgeFirstQueryTabs').tabs('add',{
            title:title,
            content:content,
            closable:true
        });
...
//提交后，删除当前选项卡
function removeTab(){
	var tab = $('#judgeFirstQueryTabs').tabs('getSelected');
	var tabIndex=$('#judgeFirstQueryTabs').tabs('getTabIndex',tab);
	$('#judgeFirstQueryTabs').tabs('close',tabIndex);
