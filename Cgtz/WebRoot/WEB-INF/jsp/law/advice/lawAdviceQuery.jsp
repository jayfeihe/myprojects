...
<body>
<div class="easyui-tabs" id="lawAdviceQueryTabs" data-options="fit:true">
	<div title="法律意见列表">
		<div id="main">
			<div id="part1" class="part">
				...
				<div class="content">
					<form id="queryForm" action="law/advice/list.do" method="post" target="queryContent">
						<table>
							<tr>
								<td>申请编号:</td>
...
function addTab(title, url){
    if ($('#lawAdviceQueryTabs').tabs('exists', title)){
        $('#lawAdviceQueryTabs').tabs('select', title);
    } else {
        var content = '<iframe scrolling="auto" frameborder="0"  src="'+url+'" style="width:100%;height:100%;"></iframe>';
        $('#lawAdviceQueryTabs').tabs('add',{
            title:title,
            content:content,
            closable:true
        });
...
//提交后，删除当前选项卡
function removeTab(){
	var tab = $('#lawAdviceQueryTabs').tabs('getSelected');
	var tabIndex=$('#lawAdviceQueryTabs').tabs('getTabIndex',tab);
	$('#lawAdviceQueryTabs').tabs('close',tabIndex);
