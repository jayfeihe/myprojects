...
<div id="main">
	<div id="part1" class="part">
		<p class="title"><a href="javascript:void(0);">车商抵押更新</a></p>
		<div class="content">
			<form id="updateCardealerForm" >
				...
				<table>
					<tr>
						...
						<td><input id="size" name="size" type="text" 
								data-options="min:0,required:true,validType:['length[0,30]']" class="textbox easyui-numberbox" value="${bean.size}"/>辆</td>
					</tr>
					<tr>
						<td>所在地:</td>
						<td colspan="6">
...
function updateFunction() {
	//去掉 input 输入的 前后空格
	$('#updateCardealerForm').find('input').each(function(){
		if($(this).attr("type")!="file"){
			$(this).val($.trim($(this).val()));
		}
	});
	//验证表单验证是否通过
	if(false == $('#updateCardealerForm').form('validate') ){
	...
	//弹出异步加载 遮罩
	openMask();
	var params = $('#updateCardealerForm').serialize();
	//按钮失效防点击
