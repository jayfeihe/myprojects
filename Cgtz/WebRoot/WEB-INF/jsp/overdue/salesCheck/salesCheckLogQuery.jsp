...
<body>
	...
	<div id="part1" class="part">
		...
		<div class="content">
			<form id="querySalesCheckForm" action="overdue/salesCheck/list.do" method="post" target="querySalesCheckContent">
			<input type="hidden" value="${loanId}" name="loanId" id="loanId"/>
			</form>
			<form id="updateSalesCheckForm" action="overdue/salesCheck/list.do" method="post">
			<input type="hidden" value="${loanId}" name="loanId" id="loanId"/>
			<table>
			<tr><td colspan="2">
...
function updateSalsCheckFunction(loanId,contractId) {
	...
	$.ajax({
		type : "POST",
		url : '<%=basePath%>' + 'overdue/salesCheck/save.do?contractId='+contractId,
		...
		success : function(data) {
			...
			if ("true"==data.success) {
				$.messager.alert('消息', data.message, 'info', function(){
	                var url= "<%=basePath%>" + "overdue/salesCheck/query.do";
					window.location=url;
					window.location.reload();
					window.parent.submitForm('queryOverDueForm');
            	});
            } else {				
