...
<body>
<div class="easyui-tabs" id="pushQueryTabs" data-options="fit:true">
	<div title="推送线上列表">
		<div id="main">
			<div id="part1" class="part">
				...
				<div class="content">
					<form id="queryForm" action="push/list.do" method="post" target="queryContent">
						<table>
							<tr>
								<td>申请编号:</td>
...
function addTab(title, url){
    if ($('#pushQueryTabs').tabs('exists', title)){
        $('#pushQueryTabs').tabs('select', title);
    } else {
        var content = '<iframe scrolling="auto" frameborder="0"  src="'+url+'" style="width:100%;height:100%;"></iframe>';
        $('#pushQueryTabs').tabs('add',{
            title:title,
            content:content,
            closable:true
        });
...
//提交后，删除当前选项卡
function removeTab(){
	var tab = $('#pushQueryTabs').tabs('getSelected');
	var tabIndex=$('#pushQueryTabs').tabs('getTabIndex',tab);
	$('#pushQueryTabs').tabs('close',tabIndex);
