				...
				<form id="queryForm" action="" method="post" target="queryContent">
					...
					<table>
						<tr>
							...
							<td>时间:</td>
							<td>
								<input id="createDate" name="createDate" type="text" class="textbox easyui-datebox" 
...
function submitForm(fromId) {
	...
	var v = $("#createDate").datebox('getValue');
	if(v == null || v == '') {
		$.messager.confirm('消息', '请选择时间！');
		return;
	}
	...
	var formAction = "<%=basePath%>report/branchStock/list.do";
...
function excelExport(fromId) {
	$('#' + fromId).attr("action","<%=basePath%>report/branchStock/export.do");
