				...
				<form id="queryForm" action="" method="post" target="queryContent">
					...
					<table>
						<tr>
							...
							<td>贷款类别:</td>
							<td><input class="textbox" id="onlineType" name="onlineType" /></td>
						</tr>
						<tr>
							<td>合同开始日期:</td>
							<td>
...
function submitForm(fromId) {
	...
	var formAction = "<%=basePath%>report/projectDetail/list.do";
...
function excelExport(fromId) {
	$('#' + fromId).attr("action","<%=basePath%>report/projectDetail/export.do");
