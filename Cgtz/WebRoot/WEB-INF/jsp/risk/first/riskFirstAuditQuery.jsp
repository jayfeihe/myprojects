...
<body>
<div class="easyui-tabs" id="riskQueryTabs" data-options="fit:true">
	<div title="风控初审列表">
		<div id="main">
			<div id="part1" class="part">
				...
				<div class="content">
					<form id="queryForm" action="risk/first/list.do" method="post" target="queryContent">
						<table>
							<tr>
								<td>申请编号:</td>
							...
							<tr>
								<td>提交审核时间:</td>
								<td colspan="2">
									<input id="riskAuditTimeMin" name="riskAuditTimeMin" type="text" class="textbox easyui-datebox" 
										data-options="editable:false" style="width: 90px;"/>
									&nbsp;-&nbsp;
									<input id="riskAuditTimeMax" name="riskAuditTimeMax" type="text" class="textbox easyui-datebox" 
										data-options="editable:false" style="width: 90px;"/>
								</td>				
								<td colspan="2">
...
function addTab(title, url){
    if ($('#riskQueryTabs').tabs('exists', title)){
        $('#riskQueryTabs').tabs('select', title);
    } else {
        var content = '<iframe scrolling="auto" frameborder="0"  src="'+url+'" style="width:100%;height:100%;"></iframe>';
        $('#riskQueryTabs').tabs('add',{
            title:title,
            content:content,
            closable:true
        });
...
//提交后，删除当前选项卡
function removeTab(){
	var tab = $('#riskQueryTabs').tabs('getSelected');
	var tabIndex=$('#riskQueryTabs').tabs('getTabIndex',tab);
	$('#riskQueryTabs').tabs('close',tabIndex);
