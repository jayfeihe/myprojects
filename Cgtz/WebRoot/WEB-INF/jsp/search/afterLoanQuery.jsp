...
<div title="稽查清单">
	...
	<div id="part1" class="part">
		...
		<div class="content">
			<form id="queryAfterLoanForm" action="search/afterloan/list.do" method="post" target="queryContent">
				<table>
<tr>
<td>合同状态:</td>
...
-<input id="maxRetDate" name="maxRetDate" type="text" editable="false" class="textbox easyui-datebox" style="width:100px;"/></td>		
					...
					<tr><td></td>
						<td>
							...
							<input type="button" value="导出" class="btn" onclick="exportExcel('queryAfterLoanForm')"/>
...
function exportExcel(fromId) {
	$('#' + fromId).attr("action","<%=basePath%>search/afterloan/excel.do");
