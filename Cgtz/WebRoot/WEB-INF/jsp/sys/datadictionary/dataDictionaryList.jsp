	...
	<div class="content">
		<form name="queryList" id="queryList" method="post" action="${ pm.url}">
			<div id="control" class="control">
				<a href="javascript:void(0);" onclick="addTab('添加数据字典','<%=basePath%>sys/datadictionary/update.do')"><img src="img/square/sys_but_add.png" class='dotimg' title="添加" /></a>&nbsp;
...
<td>${data.parentKeyProp}</td>
						...
						<td>
							<a href="javascript:void(0);" onclick="addTab('【字典ID-${data.id}】更新','<%=basePath%> sys/datadictionary/update.do?id='+${data.id})">更新</a>&nbsp;
