...
.main-container{width:974px;height:370px;margin:0px auto;padding-top:30px;}
...
.main-top .cont img{height:63px;margin-top:6px;float:left;}
...
<div class="wrapper">
	<div class="main-top">
       <div class="cont"><img src="img/logocg.png" /></div> 
    </div>
							...
							<div class="loginform">
								<form method="post" action="login.do" name="LoginForm">
									...
									<tr>
										...
										<td><input class="easyui-validatebox textbox" data-options="required:true" style="height:28px !important;padding:0px 5px 0px 25px;width:220px;background:url(img/list01.png) 4px 5px no-repeat;" type="text" id="loginid" name="loginid" title="请输入用户名" value="" autocomplete="off" tabindex=2 placeholder="请输入用户名"/></td>
									</tr>
									<tr>
										<!--td nowrap="nowrap" align="right"><label class="labeltext" for="password">密&nbsp;&nbsp;&nbsp;码:</label></td-->
										<td><input class="easyui-validatebox textbox" id="pwdid" data-options="required:true" style="height:28px !important;padding:0px 5px 0px 25px;width:220px;background:url(img/list02.png) 6px 6px no-repeat;" type="text"  onfocus="this.type='password'"  name="password" title="请输入密码" value="" autocomplete="off" tabindex=3 placeholder="请输入密码"/></td>
									</tr>
									<!--
									<tr>
										 <td nowrap="nowrap" align="right"><label class="labeltext" for="password">机&nbsp;&nbsp;&nbsp;构:</label></td> 
										<td id="ort" style="padding-left:7px;">
											<input class="easyui-combobox textbox" name="orgId" id="orgId" style="height:28px !important;padding:0px 5px 0px 25px;width:254px;float:left;" placeholder="请选择机构"/>
										</td>
									</tr>-->
									<tr>
										<td>
	...
	<div class="t-b"><span class="tb-l-corner"></span><span class="tb-r-corner"></span></div>
			...
			<div class="footer-info">
				...
				<div style="border:none;">建议使用非IE内核浏览器，如Chrome，Firefox等，本软件仅供授权用户使用。</div>
			</div>
</div>
...
{ 
var tt=$("#pwdid").parent('td');

$("#pwdid").remove();

tt.append('<input class="easyui-validatebox textbox"  data-options="required:true" style="height:28px !important;padding:0px 5px 0px 25px;width:220px;background:url(img/list02.png) 6px 6px no-repeat;" type="password" name="password" title="请输入密码" value="" autocomplete="off" tabindex=3 placeholder="请输入密码"/>');
