	...
	<div class="content">
		<form name="queryList" id="queryList" method="post" action="${ pm.url}">
			<div id="control" class="control">
				<a href="javascript:void(0);" onclick="addTab('添加配置参数','<%=basePath%>sys/parameter/update.do')"><img src="img/square/sys_but_add.png" class='dotimg' title="添加" /></a>&nbsp;
...
<td>${data.discription}</td>
						...
						<td>
							<a href="javascript:void(0);" onclick="addTab('【参数ID-${data.id}】更新','<%=basePath%> sys/parameter/update.do?id='+${data.id})">更新</a>&nbsp;
