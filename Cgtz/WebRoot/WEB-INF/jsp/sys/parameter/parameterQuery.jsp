...
<body>
<div id="paramTabs" class="easyui-tabs" data-options="fit:true">
<div title="参数配置列表">
	<div id="main">
...
function addTab(title, url){
    if ($('#paramTabs').tabs('exists', title)){
        $('#paramTabs').tabs('select', title);
    } else {
...
//提交后，删除当前选项卡
function removeTab(){
	var tab = $('#paramTabs').tabs('getSelected');
	var tabIndex=$('#paramTabs').tabs('getTabIndex',tab);
	$('#paramTabs').tabs('close',tabIndex);
