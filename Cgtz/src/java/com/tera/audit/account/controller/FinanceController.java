...
public class FinanceController extends BaseController {
	...
	private final static Logger log = Logger.getLogger(FinanceController.class);
	...
	public String financeQuery(HttpServletRequest request, ModelMap map) throws Exception {
		String thisMethodName = Thread.currentThread().getStackTrace()[1].getMethodName();
		log.info(thisMethodName+":start");
		log.info(thisMethodName+":end");
		return "account/finance/financeQuery";
	}
	...
	public String financeList(HttpServletRequest request, ModelMap map) throws Exception {
		String thisMethodName = Thread.currentThread().getStackTrace()[1].getMethodName();
		log.info(thisMethodName+":start");
		...
		queryMap.put("bpmStates", new String[]{CommonConstant.PROCESS_I1});
		...
		map.put("pm", pm);
		log.info(thisMethodName+":end");
		return "account/finance/financeList";
	}
	
	@RequestMapping("/update.do")
	public String financeUpdate(Integer id, String contractId, HttpServletRequest request, HttpServletResponse response, ModelMap map) throws Exception {
		String thisMethodName = Thread.currentThread().getStackTrace()[1].getMethodName();
		log.info(thisMethodName+":start");
		...
		log.info(thisMethodName+":end");
		return "account/finance/financeUpdate";
	}
	
	@RequestMapping("/save.do")
	public void financeSave(HttpServletRequest request, HttpServletResponse response, ModelMap map) throws Exception  {
		String thisMethodName = Thread.currentThread().getStackTrace()[1].getMethodName();
		log.info(thisMethodName+":start");
		...
		try {
			...
			JsonMsg jsonMsg = this.financeService.operateProcess(bean,loginId,loginOrg.getOrgId());
