...
public class JavaMail {
     ...
     *            收件人地址
     */
    public void informMsg(String subject, String sendHtml,
            String receiveUser) {
        try {
            // 发件人
            //InternetAddress from = new InternetAddress(sender_username);
            // 下面这个是设置发送人的Nick name
            InternetAddress from = new InternetAddress(MimeUtility.encodeWord("草根线下业务系统通知")+" <"+sender_username+">");
    ...
    public static void main(String[] args) {
        ...
        se.informMsg("邮件主题32", "邮件内容2222223333", "675983056@qq.com");
    }
}