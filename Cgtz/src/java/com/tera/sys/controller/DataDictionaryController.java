...
public class DataDictionaryController {
	...
	public String dataDictionaryList(HttpServletRequest request, ModelMap map) throws Exception {
		...
		PageList<DataDictionary> dataDictionaryList = this.dataDictionaryService.queryPageList(queryMap);
		pm.setData(dataDictionaryList);
		pm.initRowsCount(dataDictionaryList.getPaginator().getTotalCount());
		map.put("pm", pm);
		log.info(thisMethodName+":end");
