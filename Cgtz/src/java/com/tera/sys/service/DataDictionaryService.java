...
public class DataDictionaryService<T> extends MybatisBaseService<DataDictionary> {
	...
	public PageList<DataDictionary> queryPageList(Map<String, Object> params) {
		return this.selectPageList(DataDictionaryDao.class, "queryList", params);
	}
