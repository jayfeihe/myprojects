 ...
 */
@Service
public class RoleService extends MybatisBaseService<Role>{
...
//	}
	...
	public PageList<Role> queryPageList(Map<String, Object> params) {
		return this.selectPageList(RoleDao.class, "queryRole", params);
	}
