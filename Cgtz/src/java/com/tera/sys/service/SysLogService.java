 ...
 */
@Service
public class SysLogService extends MybatisBaseService<SysLog>{
	/**
	 * 日志DAO
	 */
	@Autowired
	...
	public PageList<SysLog> queryPageList(Map<String, Object> params) {
		return this.selectPageList(SysLogDao.class, "querySysLogList", params);
	}
}
