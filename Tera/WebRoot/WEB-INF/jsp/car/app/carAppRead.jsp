...
<div id="main">
	<div id="part1" class="part">
		<p class="title"><a href="javascript:void(0);">个人车贷申请信息</a></p>
		<div class="content">
				<table id="appInfo">
					<div style="margin-left: 10px;margin-top: 10px; font-size: 14px;"><strong>借款信息</strong></div><hr/>
					<tr>
						<td>客户来源:</td>
						<td><input id="customerSource" name="carApp.customerSource" type="text" 
						class="easyui-combobox" value="${bean.customerSource}" /></td>
						<td>营销人员:</td>
						<td><input id="staffNo" name="carApp.staffNo" type="text" 
						class="easyui-combobox" value="${bean.staffNo}" /></td>
						<td>申请编码:</td>
						<td><input id="appCode" name="carApp.appCode" type="text" 
						class="textbox easyui-validatebox" value="${bean.appCode}"/></td>
					</tr>
					<tr>
						<td align="right">渠道:</td>
						<td><input id="belongChannel" name="carApp.belongChannel" type="text" 
						class="easyui-combobox" editable="false" value="${bean.belongChannel}"/></td>
						<td align="right">产品:</td>
						<td><input id="product" name="carApp.product" type="text" 
					...
					<tr>
						...
						<td>借款期限:</td>
						<td><input id="period" name="carApp.period" type="text" 
						class="textbox easyui-numberbox" value="${bean.period}" style="width:128px;"/>个月</td>
						<td>借款用途:</td>
						<td colspan="3"><input id="useage1" name="carApp.useage1" type="text" 
						class="easyui-combobox" value="${bean.useage1}" />
						<input id="useage2" name="carApp.useage2" type="text" 
				...
				<table id="basicInfo">
					...
					<tr>
						...
						<td><input id="name" name="carApp.name" type="text" 
							class="textbox easyui-validatebox" value="${bean.name}"/></td>
						<td>身份证号:</td>
						<td><input id="idNo" name="carApp.idNo" onChange="getCustomer();" type="text" 
						class="textbox easyui-validatebox" value="${bean.idNo}"/></td>
						<td><SPAN style="color:red">*</SPAN>手机号:</td>
						<td><input id="mobile" name="carApp.mobile" type="text" 
						class="textbox easyui-validatebox" value="${bean.mobile}"/></td>
						<td>学历:</td>
						<td><input id="diploma" name="carApp.diploma" type="text" 
						class="easyui-combobox" value="${bean.diploma}" /></td>
					</tr>	
					<tr>	
						<td>微信:</td>
						<td><input id="wechat" name="carApp.wechat" type="text" 
						class="textbox easyui-validatebox" value="${bean.wechat}"/></td>
						<td>邮箱:</td>
						<td><input id="email" name="carApp.email" type="text" 
			...
			<div id = "marriageDiv" <c:if test="${bean.marriage!='02'}">style="display: none;"</c:if>>
				<table id="spouse">	
					...
					<tr>
						<td><SPAN style="color:red">*</SPAN>姓名:</td>
						<td><input id="spouseName" name="carApp.spouseName" type="text" 
						class="textbox easyui-validatebox" value="${bean.spouseName}"/></td>
						<td>身份证号:</td>
						<td><input id="spouseIdNo" name="carApp.spouseIdNo" type="text"
						class="textbox easyui-validatebox" value="${bean.spouseIdNo}"/></td>
						<td><SPAN style="color:red">*</SPAN>手机:</td>
						<td><input id="spouseMobile" name="carApp.spouseMobile" type="text" 
						class="textbox easyui-validatebox" value="${bean.spouseMobile}"/></td>
					</tr>
					<tr>
						<td>单位名称:</td>
						<td><input id="spouseComName" name="carApp.spouseComName" type="text" 
						class="textbox easyui-validatebox" value="${bean.spouseComName}"/></td>
						<td>年收入:</td>
						<td><input id="spouseIncome" name="carApp.spouseIncome" type="text" data-options="required:true,min:0,precision:2"
						class="textbox easyui-numberbox" value="${bean.spouseIncome/10000}" style="width:128px;"/>万元</td>
						<td>职业:</td>
						<td><input id="spouseJob" name="carApp.spouseJob" type="text" 
						class="textbox easyui-validatebox" value="${bean.spouseJob}"/></td>
					</tr>
					<tr>
						<td>单位地址:</td>
						<td colspan="5"><input id="spouseComProvince" name="carApp.spouseComProvince" type="text" 
						class="easyui-combobox" value="${bean.spouseComProvince}" style="width:140px;" />省
						<input id="spouseComCity" name="carApp.spouseComCity" type="text" 
						class="easyui-combobox" value="${bean.spouseComCity}" style="width:140px;" />市
						<input id="spouseComCounty" name="carApp.spouseComCounty" type="text" 
						class="easyui-combobox" value="${bean.spouseComCounty}" style="width:128px;" />区县
						<input id="spouseComAddress" name="carApp.spouseComAddress" type="text" 
				...
				<table>	
					...
					<tr>
						...
						<td id="carExt_1">
							...
							<input id="remarks" name="carExts[0].remarks" type="text" 
						...
						<td id="carExt_2">
							...
							<input id="remarks" name="carExts[1].remarks" type="text" 
					...
					<tr>
						...
						<td id="carExt_3">
							...
							<input id="remarks" name="carExts[2].remarks" type="text" 
						...
						<td id="carExt_4">
							...
							<input id="remarks" name="carExts[3].remarks" type="text" 
					...
					<tr>
						...
						<td id="carExt_5">
							...
							<input id="remarks" name="carExts[4].remarks" type="text" 
						...
						<td id="carExt_6">
							...
							<input id="remarks" name="carExts[5].remarks" type="text" 
