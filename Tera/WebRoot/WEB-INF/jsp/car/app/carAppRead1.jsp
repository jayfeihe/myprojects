...
<table id="appInfo">
	...
	<tr>
		<td>进件单位:</td>
		<td><input id="orgId" name="carApp.orgId" type="text" data-options="required:true,validType:['length[0,50]']" 
		class="textbox easyui-validatebox" value="${bean.orgId}"/></td>
		<td>进件日期:</td>
		<td><input id="inputTime" name="carApp.inputTime" type="text" data-options="required:true,validType:['length[0,50]']" 
	...
	<tr>
		<td>借款用途:</td>
		<td colspan="3"><input id="useage1" name="carApp.useage1" type="text" data-options="required:true,validType:['length[0,2]']" 
...
<hr color="#D3D3D3" width="100%" size="2" />
	<tr>
		...
		<td>证件号码:</td>
		<td><input id="idNo" name="carApp.idNo" type="text" data-options="required:true,validType:['length[0,50]']" 
		class="textbox easyui-validatebox" value="${bean.idNo}"/></td>
	</tr>	
	<tr>
		<td>性别:</td>
		<td><input id="sex" name="carApp.sex" type="text" data-options="required:true,validType:['length[0,2]']" 
	...
	<tr>
		<td>居住地址:</td>
		<td colspan="3"><input id="addProvince" name="carApp.addProvince" type="text" data-options="required:true,validType:['length[0,10]']" 
	...
	<tr>
		<td></td>
		<td colspan="3"><input id="addCounty" name="carApp.addCounty" type="text" data-options="required:true,validType:['length[0,10]']" 
	...
	<tr>
		<td>单位地址:</td>
		<td colspan="3"><input id="comProvince" name="carApp.comProvince" type="text" data-options="required:true,validType:['length[0,10]']" 
	...
	<tr>
		<td></td>
		<td colspan="3"><input id="comCounty" name="carApp.comCounty" type="text" data-options="required:true,validType:['length[0,10]']" 
	...
	<tr>
		...
		<td>单位电话:</td>
		<td><input id="comPhone" name="carApp.comPhone" type="text" data-options="required:true,validType:['length[0,20]']" 
	...
	<tr>
		...
		<td>工作年限:</td>
		<td><input id="workAge" name="carApp.workAge" type="text" editable="false" data-options="required:true" 
