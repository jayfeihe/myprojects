...
<div id="main">
	<div id="part1" class="part">
		...
		<div class="content">
			<form id="updateForm" name="carApp.updateForm" action="" AUTOCOMPLETE="off">
...
<!-- 							<input type="button" value="保存" class="btn" onclick="javascript:updateFunction('save');"/>&nbsp;&nbsp; -->
							<input type="button" value="前端拒贷" class="btn" onclick="javascript:artOpenPage('前端拒贷','car/app/frontRefusePopupReplenish.do?id=${bean.id}');" title="拒贷"/>&nbsp;&nbsp;
...
$(document).ready(function (){
	...
	//填充select数据 产品
	tsurl="product/hedao/listjason.do?type=4&state=1";
