	...
	<body>
		<div id="main">
			<div id="part1" class="part">
				...
				<div class="content">
					<form id="queryForm" action="car/assign/review/list.do" method="post" target="queryContent">
						<table>
							<tr>
								<td>申请编号:</td>
...
function assignUser(){
		...
		$.ajax( {
			type : "POST",
			url : "car/assign/review/update.do",
...
$(document).ready(function() {
	//填充当前复核人
	var tsurl=encodeURI("sys/user/listUserByOrgAndRole.do?orgId=${login_org.orgId}&roleNames=车贷复核专员");
