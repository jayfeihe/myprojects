...
<c:if test="${fn:contains(carDecision1.product,'精英贷') and not empty bean.gradeRemind}">&nbsp;&nbsp;|&nbsp;&nbsp;${bean.gradeRemind}</c:if>
</span>
	</p>
<div class="content">
...
<%--							测试码--%>
									...
									<td style="display: none;" id="selectCode" class="JYDTestScheme">
										<input disabled="disabled" id="secondTestCode" name="decision.secondTestCode" value="${carDecision2.secondTestCode}"
