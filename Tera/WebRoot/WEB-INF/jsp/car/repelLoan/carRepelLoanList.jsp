			...
			<table id="table" class="datatable" summary="list of members in EE Studay">
				...
				<c:forEach items="${ pm.data}" var="data" varStatus="status">
					<tr>
						...
						<td><a href="car/repelLoan/read.do?id=${data.appId}" target="_blank">${data.loanAppId}</a></td>
						<td>${data.appName}</td>
						...
						<td>${data.orgName}</td>
						<td>
							<a href="javascript:void(0);" onclick="javascript:artOpenPage('拒贷详情','car/repelLoan/repelLoanPopup.do?id=${data.appId}')">拒贷</a>
