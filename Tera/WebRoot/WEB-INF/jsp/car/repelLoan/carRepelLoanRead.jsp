...
<div id="part1" class="part">
	<p class="title">
		<a href="javascript:void(0);">车贷查询</a>
...
<%--								class="easyui-combobox"  value="${bean.period}" editable="false" style="width:152px;" disabled="disabled"/></td>--%>
								...
								<td id="carDecision_1">
									...
									<td align="right" colspan="4">
										<div id ="noPassReasonDiv1">
											退回原因:<textarea value="${carDecision1.returnMsg}" class="easyui-validatebox"
												data-options="validType:['length[0,500]']" 
												style="resize: none;width:325px;height:50px;vertical-align:middle;background-color: #F0F0F0;" disabled="disabled">${carDecision1.returnMsg}</textarea>
										</div>
							...
							<tr>
								<td>
									...
									<td colspan="5">
										...
										style="resize: none;width:625px;height:50px!important;background-color: #F0F0F0;" disabled="disabled">${carDecision1.remarks}</textarea>
									</td>
								</td>								
							</tr>
						</table>
								...
								<td>
									...
									<td align="right" colspan="4">
										<div id ="noPassReasonDiv2">
											退回原因:<textarea value="${carDecision2.returnMsg}" class="easyui-validatebox"
												data-options="validType:['length[0,500]']" 
												style="resize: none;width:325px;height:50px;vertical-align:middle;background-color: #F0F0F0;" disabled="disabled">${carDecision2.returnMsg}</textarea>
										</div>
								...
								<td>
									...
									<td colspan="5">
										<div id="feedbackSellDescribeDiv2">
											<textarea value="${carDecision2.feedbackDescribe}" class="textbox easyui-validatebox"
											style="resize: none;width:625px;height:50px!important;vertical-align:middle;background-color: #F0F0F0;" disabled="disabled">${carDecision2.feedbackDescribe}</textarea>
										</div>
									</td>
								</td>
							</tr>
	...
	<%--								</td>--%>
									<td align="right">渠道:
										...
										data-options="validType:['length[0,50]']" editable="false" value="${carDecision3.belongChannel}" disabled="disabled"/>
									</td>
									<td align="right">产品:
										<input id="product" name="decision.product" type="text"
										<c:choose><c:when test="${null == carDecision3.product || '' eq carDecision3.product}">value='${carDecision2.product }'</c:when><c:otherwise>value='${carDecision3.product }'</c:otherwise></c:choose> 
							...
							<tr>
								<td id="carDecision_1">
									...
									<td>
										<select id="decision1" name="decision.decision" value="${carDecision3.decision}" disabled="disabled"
											data-options="validType:['length[0,50]']
											,onChange: function(decisionVal){
									...
									<td align="right" colspan="4">
										<div id ="noPassReasonDiv">
											退回原因:<textarea id="returnMsg" name="decision.returnMsg" value="${carDecision3.returnMsg}" class="easyui-validatebox"
												data-options="required:true,validType:['length[0,500]']" 
												style="resize: none;width:325px;height:50px;vertical-align:middle;" disabled="disabled">${carDecision3.returnMsg}</textarea>
										</div>
								...
								<td>
									...
									<td colspan="5">
										<div id="feedbackSellDescribeDiv4">
											<textarea value="${carDecision3.feedbackDescribe}" class="textbox easyui-validatebox"
											style="resize: none;width:625px;height:50px!important;vertical-align:middle;background-color: #F0F0F0;" disabled="disabled">${carDecision3.feedbackDescribe}</textarea>
										</div>
									</td>
								</td>
							</tr>
							<tr>
								<td id="carDecision_2">
									...
									<td colspan="5">
										...
										style="resize: none;width:625px;height:50px!important;background-color: #F0F0F0;" disabled="disabled">${carDecision3.remarks}</textarea>
									</td>
								</td>								
							</tr>
						</table>
...
function updateYhkje(){
	if($('#specialApprovalInfo').find('#amount').val() != '' && $('#specialApprovalInfo').find('#product').combobox('getValue') != ''){
		updateJe("<%=basePath%>" + "car/verify/getYhkje.do", "fkje=" + $('#specialApprovalInfo').find('#amount').val() + "&productName=" + $('#specialApprovalInfo').find('#product').combobox('getValue'), "yhkje");
	}
}
...
function updateFkje(){
	if($('#specialApprovalInfo').find('#yhkje3').val() != '' && $('#specialApprovalInfo').find('#product').combobox('getValue') != ''){
		updateJe("<%=basePath%>" + "car/verify/getFkje.do", "yhkje=" + $('#specialApprovalInfo').find('#yhkje3').val() + "&productName=" + $('#specialApprovalInfo').find('#product').combobox('getValue'), "fkje");
	}
}
...
$(document).ready(function (){
	...
	if('${carDecision3.decision}' == '' || '${carDecision3.decision}' == '01'){
		$('#noPassReasonDiv').hide();//隐藏div 
		toggleValidate('#noPassReasonDiv',false);
		$('#returnCodeDiv').hide();//隐藏div 
		toggleValidate('#returnCodeDiv',false);
...
/* 	$("#specialApprovalInfo").find('#decision1').combobox("clear");
	...
	$("#specialApprovalInfo").find('#belongChannel').combobox({
		...
		onChange: function(newValue, oldValue){             
			...
			var producturl3 = "product/hedao/listjason.do?type=4&belongChannel=" + encodeURI(newValue);
	...
	var producturl3 = "product/hedao/listjason.do?type=4&belongChannel=" + encodeURI(belongChannel3);
	$("#specialApprovalInfo").find("#product").combobox("clear");
	$("#specialApprovalInfo").find('#product').combobox({
		...
		onChange: function(productVal){
			if($('#specialApprovalInfo').find('#amount').val() != '')
				updateJe("<%=basePath%>" + "car/verify/getYhkje.do", "fkje=" + $('#specialApprovalInfo').find('#amount').val() + "&productName=" + productVal, "yhkje");
		}	
	});	
