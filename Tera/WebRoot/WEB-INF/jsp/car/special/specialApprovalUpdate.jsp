...
<form id="updateForm" >
	...
	<div class="easyui-tabs" id="verify_tabs" style="height:730px;" data-options="fit:true,onLoad:tabsReadOnly">
		<div title="风险提示" data-options="href:'${basePath}car/rule/read.do'" style="width: 100%;padding:10px"></div>
		<div title="信息核查" data-options="href:'${basePath}car/verify/infoCheck.do?id=${bean.id}'" style="width: 100%;padding:10px"></div>
		<div title="影像摘要" data-options="href:'${basePath}car/verify/imageSummary.do?id=${bean.id}'" style="width: 100%;padding:10px"></div>
		<div title="信用报告" data-options="href:'${basePath}car/verify/creditReport.do?id=${bean.id}'" style="width: 100%;padding:10px"></div>
		<div title="面审调查" data-options="href:'${basePath}car/verify/interviewSurvey.do?id=${bean.id}'" style="width: 100%;padding:10px"></div>
			 	...
			 	<tr><td>
			 		<table id="verifyInfo">
			 			<tr>
			 				<td>
								<td align="right">借款金额:</td>
								<td><input value="${carDecision1.amount/10000}" type="text"
...
<%--								<td ><input id="period" value="${carDecision1.period}" type="text" data-options="validType:['length[0,10]']" --%>
...
<%--								</td>--%>
								<td align="right">渠道:
									...
									data-options="validType:['length[0,50]']" editable="false" value="${carDecision1.belongChannel}" disabled="disabled"/>
								</td>
								<td align="right">产品：
									<input id="product" value="${carDecision1.product}" type="text"  data-options="validType:['length[0,50]']" 
									class="easyui-combobox" editable="false" style="width:152px;" disabled="disabled"/>
								</td>
							</td>
						</tr>
						...
						<tr>
							<td>
								<td>审核人：</td>
								<td><input value="${carDecision1.operator}" type="text"
						...
						<tr>
							<td id="carDecision_1">
								...
								<td>
									<select disabled="disabled" id="decision" value="${carDecision1.decision}"
								...
								<c:if test="${carDecision1.decision eq '00'}">
									<div id ="noPassReasonDiv1">
										退回原因:<textarea value="${carDecision1.returnMsg}" class="textbox easyui-validatebox"
											data-options="validType:['length[0,500]']" 
											style="resize: none;width:325px;height:50px!important;vertical-align:middle;background-color: #F0F0F0;" disabled="disabled">${carDecision1.returnMsg}</textarea>
									</div>
								</c:if>
								<c:if test="${carDecision1.decision eq '03'}">
									<div id ="decisionCodeDiv1">
										违例码:
										<input value="${carDecision1.decisionCode1}" type="text" data-options="validType:['length[0,50]']" 
											class="easyui-combobox" editable="false" style="width:152px;" disabled="disabled"/>
										<input value="${carDecision1.decisionCode2}" type="text" data-options="validType:['length[0,50]']" 
											class="easyui-combobox" editable="false" style="width:152px;" disabled="disabled"/>
									</div>
								</c:if>
									<div id ="returnCodeDiv1">
										拒件码：
										<input id="decisionCode3" value="${carDecision1.decisionCode3}" type="text" data-options="validType:['length[0,50]']" 
											class="easyui-combobox" editable="false" style="width:152px;" disabled="disabled"/>
										<input id="decisionCode4" value="${carDecision1.decisionCode4}" type="text" data-options="validType:['length[0,50]']" 
											class="easyui-combobox" editable="false" style="width:152px;" disabled="disabled"/>
									</div>
								</td>
							</td>
						...
						<tr>
							<td>
								...
								<td colspan="5">
									...
									style="font-size:12px;resize: none;width:625px;height:50px!important;background-color: #F0F0F0;" disabled="disabled">${carDecision1.remarks}</textarea>
								</td>
							</td>							
						</tr>
					</table>
				...
				<tr><td>
			 		<table id="approvalInfo">
			 			<tr>
			 				<td>
								<td align="right">借款金额:</td>
								<td><input value="${carDecision2.amount/10000}" type="text"
										data-options="required:true,min:0,precision:2" class="textbox easyui-numberbox" style="width:128px;" disabled="disabled"/>万元
								</td>
<%--								<td align="light">借款期限:</td>--%>
<%--								<td ><input id="period" value="${carDecision2.period}" type="text" data-options="validType:['length[0,10]']" --%>
<%--									class="easyui-combobox" editable="false" style="width:152px;" disabled="disabled"/>--%>
<%--								</td>--%>
								<td align="right">渠道:
									<input id="belongChannel" type="text" class="easyui-combobox" 
									data-options="validType:['length[0,50]']" editable="false" value="${carDecision2.belongChannel}" disabled="disabled"/>
								</td>
								<td align="right">产品：
									<input id="product" value="${carDecision2.product}" type="text"  data-options="validType:['length[0,50]']" 
									class="easyui-combobox" editable="false" style="width:152px;" disabled="disabled"/>
								</td>
							</td>
						</tr>
						...
						<tr>
							<td>
								<td>审批人：</td>
								<td><input value="${carDecision2.operator}" type="text"
											data-options="validType:['length[0,30]']"
											class="textbox easyui-validatebox" style="width:148px;" disabled="disabled"/>
									<input type="hidden" name="carApprovalOperator" value="${carDecision2.operator}" /></td>
								<td colspan="4">&nbsp;</td>
							</td>
						</tr>
						<tr>
							<td>
								...
								<td><select disabled="disabled" id="decision1" value="${carDecision2.decision}"
										data-options="validType:['length[0,50]']
										,onChange: function(decisionVal){
											if(decisionVal == '00'){
								...
								<td align="right" colspan="4">
									<c:if test="${carDecision2.decision eq '00'}">
										<div id ="noPassReasonDiv2">
											退回原因:<textarea value="${carDecision2.returnMsg}" class="textbox easyui-validatebox"
												data-options="validType:['length[0,500]']" 
												style="resize: none;width:325px;height:50px~important;vertical-align:middle;background-color: #F0F0F0;" disabled="disabled">${carDecision2.returnMsg}</textarea>
										</div>
									</c:if>
									<c:if test="${carDecision2.decision eq '04'}">
										<div id ="decisionCodeDiv2">
											违例码:
											<input value="${carDecision2.decisionCode1}" 
												type="text" data-options="validType:['length[0,50]']" class="easyui-combobox" editable="false" style="width:152px;" disabled="disabled"/>
											<input value="${carDecision2.decisionCode2}" 
												type="text" data-options="validType:['length[0,50]']" class="easyui-combobox" editable="false" style="width:152px;" disabled="disabled"/>
										</div>
									</c:if>
									<c:if test="${carDecision2.decision eq '05'}">
										<div id ="returnCodeDiv2">
											拒件码:
											<input id="decisionCode3" value="${carDecision2.decisionCode3}" 
												type="text" data-options="validType:['length[0,50]']" class="easyui-combobox" editable="false" style="width:152px;" disabled="disabled"/>
											<input id="decisionCode4" value="${carDecision2.decisionCode4}" 
												type="text" data-options="validType:['length[0,50]']" class="easyui-combobox" editable="false" style="width:152px;" disabled="disabled"/>
										</div>
									</c:if>
								</td>
						...
						<tr>
							<td>
								...
								<td colspan="5">
									<textarea class="textbox easyui-validatebox" data-options="validType:['length[0,500]']" 
									style="resize: none;width:625px;height:50px!important;background-color: #F0F0F0;" disabled="disabled">${carDecision2.remarks}</textarea>
								</td>
							</td>								
						</tr>
					</table>
							...
							<tr>
								...
								<td><input type="text" id="fraudResult"  class="textbox easyui-combobox" 
									...
									data-options="valueField:'keyProp', 
												textField:'keyValue',
												panelHeight:'auto',
												value:'${carFraud.result }',
												data:[{'keyProp':'1','keyValue':'无问题'},
													  {'keyProp':'2','keyValue':'有问题'}]"/>
								</td>
								<td align="right">处理人：</td>
								<td>
									<input type="text" value="${carFraud.operatorName }" class="textbox" disabled="disabled"/>
								</td>
							</tr>
							<tr>
								...
								<td colspan="4">
									...
									style="resize: none;width:304px;height:60px!important;">${carFraud.resultInfo }</textarea>
								</td>
							</tr>
						</table>
					</td></tr>
			 		...
			 		<table id="specialApprovalInfo">
			 			<tr>
			 				<td id="carDecision_0">
					 			...
					 			<input type="hidden" name="decision.id" value="${carDecision3.id}" />
								<input type="hidden" name="decision.appId" value="${bean.appId}" />
								<input type="hidden" name="decision.type" value="3" />
								<input type="hidden" id="state" name="decision.state" value="${carDecision3.state}" />
								<td align="right">借款金额:</td>
								<td><div id="amountDiv">
									<input id="amount" name="decision.amount" value="${carDecision3.amount/10000}" type="text"
...
<%--								<td align="light">借款期限:</td>--%>
<%--								<td ><input id="period" name="decision.period" <c:if test="${0 != carDecision3.period}">value='${carDecision3.period}'</c:if> type="text" --%>
...
<%--								</td>--%>
								<td align="right">渠道:
									...
									data-options="required:true,validType:['length[0,50]']" editable="false" value="${carDecision3.belongChannel}"/>
								</td>
								<td align="right">产品：
									<input id="product" name="decision.product" type="text" value="${carDecision3.product }"
						...
						<tr>
							<td id="carDecision_1">
								...
								<td>
									<select id="decision1" name="decision.decision" value="${carDecision3.decision}"
										data-options="validType:['length[0,50]']
										,onChange: function(decisionVal){
								...
								<td align="right" colspan="4">
									<div id ="noPassReasonDiv">
										退回原因:<textarea id="returnMsg" name="decision.returnMsg" value="${carDecision3.returnMsg}" class="textbox easyui-validatebox"
											data-options="required:true,validType:['length[0,500]']" 
											style="resize: none;width:325px;height:50px!important;vertical-align:middle;">${carDecision3.returnMsg}</textarea>
									</div>
									<div id ="returnCodeDiv">
										拒件码:
										<input id="decisionCode3" name="decision.decisionCode3" value="${carDecision3.decisionCode3}" 
											type="text" data-options="validType:['length[0,50]']" class="easyui-combobox" editable="false" style="width:152px;" />
										<input id="decisionCode4" name="decision.decisionCode4" value="${carDecision3.decisionCode4}" 
											type="text" data-options="validType:['length[0,50]']" class="easyui-combobox" editable="false" style="width:152px;" />
									</div>
								</td>
							</td>
						...
						<tr>
							<td id="carDecision_2">
								...
								<td colspan="5">
									...
									style="resize: none;width:625px;height:50px!important;">${carDecision3.remarks}</textarea>
								</td>
							</td>								
						</tr>
						<tr>
...
function updateFunction() {
	...
	$.ajax({
		type : "POST",
		url : "<%=basePath%>" + "car/decision/save.do",
		...
		success : function(data) {
			...
			if ("true"==data.success) {
				$.messager.alert('消息', data.message, 'info', function(){
//	                var url= "<%=basePath%>" + "car/special/query.do";
//					window.location=url;
					//window.history.go(-1);
					window.parent.removeTab();
            	});
...
function saveOrSubForm(buttonType){
	...
	$.ajax({
		type : "POST",
		url : "<%=basePath%>" + "car/special/save.do",
		data : params+"&buttonType="+buttonType,
		success : function(data) {
			//关闭遮罩，弹出消息框
			window.parent.closeMask();
...
function updateYhkjeHtje(){
	if($('#specialApprovalInfo').find('#amount').val() != '' && $('#specialApprovalInfo').find('#product').combobox('getValue') != ''){
		updateJe("<%=basePath%>" + "car/verify/getJe.do", "yhkje=0.00&htje=0.00&jkje=" + $('#specialApprovalInfo').find('#amount').val() + "&productName=" + $('#specialApprovalInfo').find('#product').combobox('getValue'), "jkje");
	}
}
...
function updateJkjeHtje(){
	if($('#specialApprovalInfo').find('#yhkje3').val() != '' && $('#specialApprovalInfo').find('#product').combobox('getValue') != ''){
		updateJe("<%=basePath%>" + "car/verify/getJe.do", "jkje=0.00&htje=0.00&yhkje=" + $('#specialApprovalInfo').find('#yhkje3').val() + "&productName=" + $('#specialApprovalInfo').find('#product').combobox('getValue'), "yhkje");
	}
}
...
function updateJkjeYhkje(){
	if($('#specialApprovalInfo').find('#htje').val() != '' && $('#specialApprovalInfo').find('#product').combobox('getValue') != ''){
		updateJe("<%=basePath%>" + "car/verify/getJe.do", "jkje=0.00&yhkje=0.00&htje=" + $('#specialApprovalInfo').find('#htje').val() + "&productName=" + $('#specialApprovalInfo').find('#product').combobox('getValue'), "htje");
	}
}
...
$(document).ready(function (){
	...
	if('${carDecision1.decision}' == '02'){
		$('#noPassReasonDiv1').show();//显示div   
		$('#decisionCodeDiv1').hide();//隐藏div  
		$('#returnCodeDiv1').hide();//隐藏div 
	}else if('${carDecision1.decision}' == '03'){
		$('#noPassReasonDiv1').show();//显示div   
		$('#decisionCodeDiv1').hide();//隐藏div  
		$('#returnCodeDiv1').hide();//隐藏div  
	}else if('${carDecision1.decision}' == '00'){
		$('#noPassReasonDiv1').show();//显示div   
		$('#decisionCodeDiv1').hide();//隐藏div  
		$('#returnCodeDiv1').hide();//隐藏div 
	}
	
	if('${carDecision2.decision}' == '00'){
		$('#noPassReasonDiv2').show();//显示div   
		$('#decisionCodeDiv2').hide();//隐藏div 
		$('returnCodeDiv2').hide();//隐藏div 
	}else if('${carDecision2.decision}' == '01'){
		$('#noPassReasonDiv2').hide();//隐藏div    
		$('#decisionCodeDiv2').hide();//隐藏div 
		$('returnCodeDiv2').hide();//隐藏div  
	}else if('${carDecision2.decision}' == '05'){
		$('#noPassReasonDiv2').hide();//隐藏div    
		$('#decisionCodeDiv2').hide();//隐藏div 
		$('returnCodeDiv2').show();//显示div  
	}else if('${carDecision2.decision}' == '04'){
		$('#noPassReasonDiv2').hide();//隐藏div    
		$('#decisionCodeDiv2').hide();//隐藏div 
		$('returnCodeDiv2').hide();//隐藏div   
	}else{
	...
	if('${carDecision3.decision}' == '00'){
		toggleValidate('#specialApprovalInfo',false);
	}else{
		toggleValidate('#specialApprovalInfo',true);			
	}
	
	if('${carDecision3.decision}' == '' || '${carDecision3.decision}' == '01' || '${carDecision3.decision}' == '06'){
		$('#noPassReasonDiv').hide();//隐藏div 
		toggleValidate('#noPassReasonDiv',false);
		$('#returnCodeDiv').hide();//隐藏div 
		toggleValidate('#returnCodeDiv',false);
		...
		$('#feedbackSellDescribeDiv2').hide();//隐藏div  
		toggleValidate('#feedbackSellDescribeDiv2',false);
	}else if('${carDecision3.decision}' == '00'){
		$('#noPassReasonDiv').show();//显示div 
		toggleValidate('#noPassReasonDiv',true);
		$('#returnCodeDiv').hide();//隐藏div 
		toggleValidate('#returnCodeDiv',false);
...
*/
	...
	$("#verifyInfo").find('#belongChannel').combobox({
		...
		onChange: function(newValue, oldValue){             
			...
			var producturl1 = "product/hedao/listjason.do?type=4&belongChannel=" + encodeURI(newValue);
			$("#verifyInfo").find('#product').combobox('reload',producturl1); 
		}
	});
	//填充select数据 产品
	var belongChannel1 = $("#verifyInfo").find('#belongChannel').combobox('getValue');
	var producturl1 = "product/hedao/listjason.do?type=4&belongChannel=" + encodeURI(belongChannel1);
	$("#verifyInfo").find("#product").combobox("clear");
	...
	$("#approvalInfo").find('#belongChannel').combobox({
		...
		onChange: function(newValue, oldValue){             
			...
			var producturl2 = "product/hedao/listjason.do?type=4&belongChannel=" + encodeURI(newValue);
	...
	var producturl2 = "product/hedao/listjason.do?type=4&belongChannel=" + encodeURI(belongChannel2);
	$("#approvalInfo").find("#product").combobox("clear");
	...
	$("#specialApprovalInfo").find('#belongChannel').combobox({
		...
		onChange: function(newValue, oldValue){             
			...
			var producturl3 = "product/hedao/listjason.do?type=4&state=1&belongChannel=" + encodeURI(newValue);
	...
	var producturl3 = "product/hedao/listjason.do?type=4&state=1&belongChannel=" + encodeURI(belongChannel3);
	$("#specialApprovalInfo").find("#product").combobox("clear");
	...
	$('#verifyInfo').find('#decision').combobox('setValue', '${carDecision1.decision}');
	$('#approvalInfo').find('#decision1').combobox('setValue', '${carDecision2.decision}');
	$('#specialApprovalInfo').find('#decision1').combobox('setValue', '${carDecision3.decision}'); 
