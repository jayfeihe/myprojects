	...
	<body>
		<div id="main">
			<div id="part1" class="part">
				<p class="title"><a href="javascript:void(0);">司法分单查询</a></p>

				<div class="content">
					<form id="queryForm" action="collection/judicial/assign/list.do" method="post" target="queryContent">
						<table>
							<tr>
								<td>合同编号:</td>
							...
							<td>当前催收人:</td>
								...
								<td>
									<select class="easyui-combobox" name="state" editable="false" style="width:130px;">
										...
										<option value="1">司法申请</option>
										<option value="2">司法复核</option>
										<option value="3">司法审批</option>
										<option value="10">司法审批退回</option>
										<option value="4">司法生效</option>
									</select>
								</td>
							</tr>
							<tr>
...
function assignUser(){
		...
		if(size==0) {
			$.messager.confirm('消息', "请选择待复核申请单！");
			return;
		}
		if(newprocesser=='') {
			$.messager.confirm('消息', "请选择复核人！");
			return;
		}
		openMask();
		$.ajax( {
			type : "POST",
			url : "collection/judicial/assign/update.do",
...
$(document).ready(function() {
	...
	var tsurl=encodeURI("sys/user/listUserByOrgAndRole.do?orgId=86&roleNames=司法复核专员");
	//填充复核人
