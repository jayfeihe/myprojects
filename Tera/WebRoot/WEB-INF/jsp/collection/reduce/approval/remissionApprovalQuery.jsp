...
<body>
	<div id="main">
		<div id="part1" class="part">
			<p class="title">
				<c:if test="${scope eq '1' }">
					<a href="javascript:void(0);">减免审批查询</a>
				</c:if>
				<c:if test="${scope eq '2' }">
					<a href="javascript:void(0);">减免高级审批查询</a>
				</c:if>
			</p>

			<div class="content">
				<form id="queryForm" action="collection/reduce/approval/list.do?scope=${scope }" method="post"
					target="queryContent">
					<table>
						<tr>
							<td>合同编号:</td>
