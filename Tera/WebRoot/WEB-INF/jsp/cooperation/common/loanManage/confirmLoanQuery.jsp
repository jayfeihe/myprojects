	...
	<body>
		<div id="main">
			<div id="part1" class="part">
				<p class="title">
					<a href="javascript:void(0);">渠道确认放款管理</a>
				</p>
	
				<div class="content">
					<form id="queryForm" action="cooperation/common/loanManage/list.do" method="post" target="queryContent">
						<table>
							<tr>
								<td>申请编号:</td>
								<td><input id="appNo" name="appNo" type="text"
							...
							<tr>
								<td>渠道</td>
								<td>
									<input id="channelType" name="channelType" type="text"
								...
								<td>营业部:</td>
								<td><input id="orgName" name="orgName" type="text"
...
$(document).ready(function() {
	var tsurl="product/hedao/listJsonByCooperation.do?type=3&cooperation=DX";
	...
	$('#channelType').combobox({
		...
		textField:"keyValue",
		value:'DX',
		data: dataDictJson.channelType,
		onSelect: function(){
			var newVal = $(this).combobox("getValue");
			tsurl="product/hedao/listJsonByCooperation.do?type=3&cooperation="+newVal;
			$("#product").combobox("clear");
			$('#product').combobox({url:tsurl, valueField:'name', textField:'name'});
		}
	});
