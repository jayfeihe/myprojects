	...
	<body>
		<div id="main">
			<div id="part1" class="part">
				<p class="title"><a href="javascript:void(0);">信用借款申请查询</a></p>

				<div class="content">
					<form id="queryForm" action="credit/app/list.do" method="post" target="queryContent">
						<table>
							<tr>
								<td>申请编号:</td>
...
function assignStaff(){
		...
		$.ajax( {
			type : "POST",
			url : "credit/app/updateStaffNo.do",
