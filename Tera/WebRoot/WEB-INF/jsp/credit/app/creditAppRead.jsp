...
<div id="main">
	<div id="part1" class="part">
		<p class="title"><a href="javascript:void(0);">个人信用借款申请信息</a></p>
		<div class="content">
				<table id="appInfo">
					<div style="margin-left: 10px;margin-top: 10px; font-size: 14px;"><strong>借款信息</strong></div><hr/>
					<tr>
						<td>客户来源:</td>
						<td><input id="customerSource" name="creditApp.customerSource" type="text" 
						class="easyui-combobox" value="${bean.customerSource}" /></td>
						<td>营销人员:</td>
						<td><input id="staffNo" name="creditApp.staffNo" type="text" 
						class="easyui-combobox" value="${bean.staffNo}" /></td>
						<td>申请编码:</td>
						<td><input id="appCode" name="creditApp.appCode" type="text" 
						class="textbox easyui-validatebox" value="${bean.appCode}"/></td>
					</tr>
					<tr>
						<td align="right">渠道:</td>
						<td><input id="belongChannel" name="creditApp.belongChannel" type="text" 
						class="easyui-combobox" editable="false" value="${bean.belongChannel}"/></td>
						<td align="right">产品:</td>
						<td><input id="product" name="creditApp.product" type="text" 
					...
					<tr>
						...
						<td>借款期限:</td>
						<td><input id="period" name="creditApp.period" type="text" 
						class="textbox easyui-numberbox" value="${bean.period}" style="width:128px;"/>个月</td>
						<td>借款用途:</td>
						<td colspan="3"><input id="useage1" name="creditApp.useage1" type="text" 
						class="easyui-combobox" value="${bean.useage1}" />
						<input id="useage2" name="creditApp.useage2" type="text" 
				...
				<table id="basicInfo">
					...
					<tr>
						...
						<td><input id="name" name="creditApp.name" type="text" 
							class="textbox easyui-validatebox" value="${bean.name}"/></td>
						<td>身份证号:</td>
						<td><input id="idNo" name="creditApp.idNo" onChange="getCustomer();" type="text" 
						class="textbox easyui-validatebox" value="${bean.idNo}"/></td>
						<td><SPAN style="color:red">*</SPAN>手机号:</td>
						<td><input id="mobile" name="creditApp.mobile" type="text" 
						class="textbox easyui-validatebox" value="${bean.mobile}"/></td>
						<td>学历:</td>
						<td><input id="diploma" name="creditApp.diploma" type="text" 
						class="easyui-combobox" value="${bean.diploma}" /></td>
					</tr>	
					<tr>	
						<td>微信:</td>
						<td><input id="wechat" name="creditApp.wechat" type="text" 
						class="textbox easyui-validatebox" value="${bean.wechat}"/></td>
						<td>邮箱:</td>
						<td><input id="email" name="creditApp.email" type="text" 
			...
			<div id = "marriageDiv" <c:if test="${bean.marriage!='02'}">style="display: none;"</c:if>>
				<table id="spouse">	
					...
					<tr>
						<td><SPAN style="color:red">*</SPAN>姓名:</td>
						<td><input id="spouseName" name="creditApp.spouseName" type="text" 
						class="textbox easyui-validatebox" value="${bean.spouseName}"/></td>
						<td>身份证号:</td>
						<td><input id="spouseIdNo" name="creditApp.spouseIdNo" type="text"
						class="textbox easyui-validatebox" value="${bean.spouseIdNo}"/></td>
						<td><SPAN style="color:red">*</SPAN>手机:</td>
						<td><input id="spouseMobile" name="creditApp.spouseMobile" type="text" 
						class="textbox easyui-validatebox" value="${bean.spouseMobile}"/></td>
					</tr>
					<tr>
						<td>单位名称:</td>
						<td><input id="spouseComName" name="creditApp.spouseComName" type="text" 
						class="textbox easyui-validatebox" value="${bean.spouseComName}"/></td>
						<td>年收入:</td>
						<td><input id="spouseIncome" name="creditApp.spouseIncome" type="text" data-options="required:true,min:0,precision:2"
						class="textbox easyui-numberbox" value="${bean.spouseIncome/10000}" style="width:128px;"/>万元</td>
						<td>职业:</td>
						<td><input id="spouseJob" name="creditApp.spouseJob" type="text" 
						class="textbox easyui-validatebox" value="${bean.spouseJob}"/></td>
					</tr>
					<tr>
						<td>单位地址:</td>
						<td colspan="5"><input id="spouseComProvince" name="creditApp.spouseComProvince" type="text" 
						class="easyui-combobox" value="${bean.spouseComProvince}" style="width:140px;" />省
						<input id="spouseComCity" name="creditApp.spouseComCity" type="text" 
						class="easyui-combobox" value="${bean.spouseComCity}" style="width:140px;" />市
						<input id="spouseComCounty" name="creditApp.spouseComCounty" type="text" 
						class="easyui-combobox" value="${bean.spouseComCounty}" style="width:128px;" />区县
						<input id="spouseComAddress" name="creditApp.spouseComAddress" type="text" 
...
<div id="mainBusinessInfoDiv" <c:if test="${fn:contains(bean.product,'业主贷')==false}">style="display: none;"</c:if>>
	<table>	
		...
		<tr>
			<td>商号名称:</td>
			<td><input id="firmName" name="creditApp.firmName" type="text" 
			class="textbox easyui-validatebox" value="${bean.firmName}"/></td>
			<td>主营业务:</td>
			<td><input id="firmMainBusiness" name="creditApp.firmMainBusiness" type="text" 
			class="textbox easyui-validatebox" value="${bean.firmMainBusiness}"/></td>
			<td>年营业额:</td>
			<td><input id="firmIncome" name="creditApp.firmIncome" type="text" 
			class="textbox easyui-numberbox" value="${bean.firmIncome/10000}" style="width:128px;"/>万元</td>
			<td>占股比例:</td>
			<td><input id="firmShare" name="creditApp.firmShare" type="text" 
			class="textbox easyui-numberbox" value="${bean.firmShare}" style="width:140px;"/>%</td>				
		</tr>
		<tr>
			<td>商号地址:</td>
			<td colspan="5" ><input id="firmProvince" name="creditApp.firmProvince" type="text" 
			class="easyui-combobox" value="${bean.firmProvince}" style="width:140px;" />省
			<input id="firmCity" name="creditApp.firmCity" type="text" 
			class="easyui-combobox" value="${bean.firmCity}" style="width:140px;" />市
			<input id="firmCounty" name="creditApp.firmCounty" type="text" 
			class="easyui-combobox" value="${bean.firmCounty}" style="width:128px;" />区县
			<input id="firmAddress" name="creditApp.firmAddress" type="text" 
			class="textbox easyui-validatebox" value="${bean.firmAddress}" /></td>
		</tr>
		<tr>
			<td>本地经营时间:</td>
			<td><input id="firmManageDate" name="creditApp.firmManageDate" type="text" 
				...
				<table>	
					...
					<tr>
						...
						<td id="creditExt_1">
							...
							<input id="remarks" name="creditExts[0].remarks" type="text" 
						...
						<td id="creditExt_2">
							...
							<input id="remarks" name="creditExts[1].remarks" type="text" 
					...
					<tr>
						...
						<td id="creditExt_3">
							...
							<input id="remarks" name="creditExts[2].remarks" type="text" 
						...
						<td id="creditExt_4">
							...
							<input id="remarks" name="creditExts[3].remarks" type="text" 
					...
					<tr>
						...
						<td id="creditExt_5">
							...
							<input id="remarks" name="creditExts[4].remarks" type="text" 
						...
						<td id="creditExt_6">
							...
							<input id="remarks" name="creditExts[5].remarks" type="text" 
