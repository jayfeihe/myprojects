...
<table id="appInfo">
	...
	<tr>
		<td>进件单位:</td>
		<td><input id="orgId" name="creditApp.orgId" type="text" data-options="required:true,validType:['length[0,50]']" 
		class="textbox easyui-validatebox" value="${bean.orgId}"/></td>
		<td>进件日期:</td>
		<td><input id="inputTime" name="creditApp.inputTime" type="text" data-options="required:true,validType:['length[0,50]']" 
	...
	<tr>
		<td>借款用途:</td>
		<td colspan="3"><input id="useage1" name="creditApp.useage1" type="text" data-options="required:true,validType:['length[0,2]']" 
...
<hr color="#D3D3D3" width="100%" size="2" />
	<tr>
		...
		<td>证件号码:</td>
		<td><input id="idNo" name="creditApp.idNo" type="text" data-options="required:true,validType:['length[0,50]']" 
		class="textbox easyui-validatebox" value="${bean.idNo}"/></td>
	</tr>	
	<tr>
		<td>性别:</td>
		<td><input id="sex" name="creditApp.sex" type="text" data-options="required:true,validType:['length[0,2]']" 
	...
	<tr>
		<td>居住地址:</td>
		<td colspan="3"><input id="addProvince" name="creditApp.addProvince" type="text" data-options="required:true,validType:['length[0,10]']" 
	...
	<tr>
		<td></td>
		<td colspan="3"><input id="addCounty" name="creditApp.addCounty" type="text" data-options="required:true,validType:['length[0,10]']" 
	...
	<tr>
		<td>单位地址:</td>
		<td colspan="3"><input id="comProvince" name="creditApp.comProvince" type="text" data-options="required:true,validType:['length[0,10]']" 
	...
	<tr>
		<td></td>
		<td colspan="3"><input id="comCounty" name="creditApp.comCounty" type="text" data-options="required:true,validType:['length[0,10]']" 
	...
	<tr>
		...
		<td>单位电话:</td>
		<td><input id="comPhone" name="creditApp.comPhone" type="text" data-options="required:true,validType:['length[0,20]']" 
	...
	<tr>
		...
		<td>工作年限:</td>
		<td><input id="workAge" name="creditApp.workAge" type="text" editable="false" data-options="required:true" 
