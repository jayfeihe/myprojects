...
<div id="approvalTable" class="easyui-tabs" data-options="fit:true">
<div title="审批"> 
		<div id="main">
			<div id="part1" class="part">
				<p class="title"><a href="javascript:void(0);">审批决策查询</a></p>

				<div class="content">
					<form id="queryForm" action="credit/approval/list.do" method="post" target="queryContent">
						<table>
							<tr>
								<td>申请编号:</td>
								...
								<td><input id="idNo" name="idNo" type="text"
										data-options="validType:['idcard','length[0,18]']"
										class="textbox easyui-validatebox" /></td>
							</tr>
							<tr>
								<td>进件时间:</td>
...
function addTab(title, url){
    if ($('#approvalTable').tabs('exists', title)){
        $('#approvalTable').tabs('select', title);
    } else {
        var content = '<iframe scrolling="auto" frameborder="0"  src="'+url+'" style="width:100%;height:100%;"></iframe>';
        $('#approvalTable').tabs('add',{
            title:title,
            content:content,
            closable:true
        });
