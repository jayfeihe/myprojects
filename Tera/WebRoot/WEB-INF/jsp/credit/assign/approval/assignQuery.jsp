	...
	<body>
		<div id="main">
			<div id="part1" class="part">
				<p class="title"><a href="javascript:void(0);">审批分单查询</a></p>

				<div class="content">
					<form id="queryForm" action="credit/assign/approval/list.do" method="post" target="queryContent">
						<table>
							<tr>
								<td>申请编号:</td>
...
function assignUser(){
		...
		if(size==0) {
			$.messager.confirm('消息', "请选择待审批申请单！");
			return;
		}
		if(newprocesser=='') {
			$.messager.confirm('消息', "请选择审批人！");
			return;
		}
		openMask();
		$.ajax( {
			type : "POST",
			url : "credit/assign/approval/update.do",
...
$(document).ready(function() {
	//填充当前审批人
	var tsurl=encodeURI("sys/user/listUserByOrgAndRole.do?orgId=${login_org.orgId}&roleNames=信用审批专员");
