	...
	<body>
		<div id="main">
			<div id="part1" class="part">
				<p class="title"><a href="javascript:void(0);">复核分单查询</a></p>

				<div class="content">
					<form id="queryForm" action="credit/assign/review/list.do" method="post" target="queryContent">
						<table>
							<tr>
								<td>申请编号:</td>
...
function assignUser(){
		...
		$.ajax( {
			type : "POST",
			url : "credit/assign/review/update.do",
...
$(document).ready(function() {
	//填充当前复核人
	var tsurl=encodeURI("sys/user/listUserByOrgAndRole.do?orgId=${login_org.orgId}&roleNames=信用复核专员");
