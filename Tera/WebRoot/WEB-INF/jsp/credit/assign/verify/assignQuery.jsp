	...
	<body>
		<div id="main">
			<div id="part1" class="part">
				...
				<div class="content">
					<form id="queryForm" action="credit/assign/verify/list.do" method="post" target="queryContent">
						<table>
							<tr>
								<td>申请编号:</td>
...
function assignProcesser(){
		...
		$.ajax( {
			type : "POST",
			url : "credit/assign/verify/update.do",
...
$(document).ready(function() {
	//填充当前审批人
	var tsurl=encodeURI("sys/user/listUserByOrgAndRole.do?orgId=${login_org.orgId}&roleNames=信用审核专员");
