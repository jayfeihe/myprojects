								...
								<td>
									...
									<td colspan="5">
										<div id="feedbackSellDescribeDiv2">
											<textarea value="${creditDecision2.feedbackDescribe}" class="textbox easyui-validatebox"
											style="resize: none;width:625px;height:50px!important;vertical-align:middle;background-color: #F0F0F0;" disabled="disabled">${creditDecision2.feedbackDescribe}</textarea>
										</div>
									</td>
								</td>
							</tr>
								...
								<td>
									...
									<td colspan="5">
										<div id="feedbackSellDescribeDiv4">
											<textarea value="${creditDecision3.feedbackDescribe}" class="textbox easyui-validatebox"
											style="resize: none;width:625px;height:50px!important;vertical-align:middle;background-color: #F0F0F0;" disabled="disabled">${creditDecision3.feedbackDescribe}</textarea>
										</div>
									</td>
								</td>
							</tr>
...
function updateYhkje(){
	if($('#specialApprovalInfo').find('#amount').val() != '' && $('#specialApprovalInfo').find('#product').combobox('getValue') != ''){
		updateJe("<%=basePath%>" + "credit/verify/getYhkje.do", "fkje=" + $('#specialApprovalInfo').find('#amount').val() + "&productName=" + $('#specialApprovalInfo').find('#product').combobox('getValue'), "yhkje");
	}
}
...
function updateFkje(){
	if($('#specialApprovalInfo').find('#yhkje3').val() != '' && $('#specialApprovalInfo').find('#product').combobox('getValue') != ''){
		updateJe("<%=basePath%>" + "credit/verify/getFkje.do", "yhkje=" + $('#specialApprovalInfo').find('#yhkje3').val() + "&productName=" + $('#specialApprovalInfo').find('#product').combobox('getValue'), "fkje");
	}
}
