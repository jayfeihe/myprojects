...
住址：<u>  ${bean.addProvince} ${bean.addCity} ${bean.addCounty} ${bean.address}  </u><br/><br/>
	&nbsp; 借款人签署有编号为 <u>  ${contract.contractNo}  </u>的《借款声明书》，借款人确认该《借款声明书》项下的还款计划内容如下：
借款金额：<u> ￥<fmt:formatNumber value="${zkbjse/10000} " pattern="#,#00.00"/> </u>万元
借款期限：<u> ${product.period }  </u>个月
</p>
...
<div style="clear:both"></div>
	<div style="height:200px;">	
		&nbsp; 利息自出借人支付的借款划转至借款人指定银行账户起计算，利息起算日与上表载明不一致的，以利息起算日为准；利息起算日迟于上表载明日期的，还款日不顺延。<br/><br/><br/>
