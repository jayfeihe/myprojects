...
<p style="text-align:right;">
 ...
 <p> 本还款计划由以下借款人于<u> ${year }  </u>年<u> ${month }  </u>月<u> ${date }  </u>日签署:</p>
   
   <p>借款人：<u>  ${bean.name}  </u><br />
	 身份证号码：<u> ${bean.idNo} </u><br />
	 住所：<u>  ${bean.addProvince} ${bean.addCity} ${bean.addCounty} ${bean.address}  </u></p>
   
   <p>&nbsp;借款人签署有编号为<u>  ${contract.contractNo}  </u> 的《借款声明书》，借款人确认该《借款声明书》项下的还款计划内容如下：</p>

	<p>借款金额：<u> ￥<fmt:formatNumber value="${zkbjse/10000} " pattern="#,#00.00"/> </u>万元
		借款期限：<u> ${product.period }  </u>个月</p>
  ...
  <c:if test="${status.index == 10}">
   ...
   <div style="clear:both"></div>
   <br/>
   <p style="text-indent: 2em;">利息自出借人支付的借款划转至借款人指定账户之日起起算。利息起算日与上表载明不一致的，以利息起算日为准；利息起算日迟于上表载明日期的，还款日依次顺延。 </p>

 <p>借款人确认同意并依照上述表单履行还款义务。 </p>
