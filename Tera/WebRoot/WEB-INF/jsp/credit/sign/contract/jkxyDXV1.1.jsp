...
<p style="text-align:left;"><br />
  本文件由以下借款人于<u>   ${year}   </u>年<u> ${month}  </u>月<u> ${date}  </u>日在<u>   ${contract.signProvince}    ${contract.signCity}   ${contract.signCounty}  </u>签署： </p>
<p style="text-align:left;"><br />
  姓名： <u> ${bean.name }  </u><br/>
  身份证号码： <u> ${bean.idNo} </u><br/>
 住址： <u>  ${bean.addProvince} ${bean.addCity} ${bean.addCounty} ${bean.address}  </u><br/>
  联系方式： <u> ${contract.bankMobile} </u><br/>
<strong>鉴于：</strong><br/>
&nbsp; &nbsp; &nbsp; 经由${companyName}资信评估及推荐，本人自愿通过鼎轩资产管理（上海）有限公司向其客户（以下称出借人）借款并同意签署本文件。<br/>
&nbsp; &nbsp; &nbsp; 本声明书内容为借款人向出借人借款（以下简称<strong>“借款事项”</strong>）的具体合同条款，声明内容如下：<br/>
</p>
<p> <br />
...
<p align="left">1.2 借款人委托鼎轩资产管理（上海）有限公司将上述借款经由支付机构划扣至上述表格中借款人指定的收款账户。<br />
...
&nbsp; &nbsp; &nbsp; 依据《融资服务协议》（编号： <u> ${contract.contractNo}-01  </u>），借款人应向服务提供方各方（包括${companyName}、鼎轩资产管理（上海）有限公司）支付相关服务费用，并委托鼎轩资产管理（上海）有限公司通过支付机构在其取得的借款中直接划转并代为支付上述约定的服务费用。<br />
  ...
  4.3 借款人按照4.1款约定进行提前还款的，相应款项足额支付给出借人后，本协议自行终止，无需另行确认。 <br />
  <strong>第五条 诚实守法义务 </strong><br />
  5.1 借款人承诺向出借人、${companyName}及鼎轩资产管理（上海）有限公司如实陈述及披露相关信息，保证其提供的信息和资料的真实性、准确性、合法性，且无事实的隐瞒。 <br />
  5.2 借款人承诺不会将所借款项用于任何违法活动，包括但不限于赌博、吸毒、贩毒、卖淫嫖娼等。 <br />
  <strong>第六条	违约责任</strong><br />
  6.1 借款人未按照协议约定于还款日当日18:00前将应还款金额足额存入指定还款账户，致使账户中的余额不足以支付当期应付本金及利息的，将被视为还款逾期，应支付逾期违约金及罚息。（逾期违约金：当月应还本息的10%，计算金额不足人民币100元的按照100元计，多期还款逾期情形下，针对每期逾期应独立计算逾期违约金，甲方应付逾期违约金为各期独立计算的逾期违约金金额之和；罚息：每日按照借款金额的0.05%收取罚息；多期还款逾期情形下，针对每期逾期应独立计算罚息，甲方应付罚息为各期独立计算的罚息金额之和。）。<br />
...
&nbsp; &nbsp; &nbsp; 上述情形下借款人应于被宣告合同解除之日起3日内，依据出借人或${companyName}的要求一次性支付本金、利息、罚息和逾期违约金等，否则视为逾期还款，依上述6.1款所述支付罚息及违约金。<br />
  ...
  6.5 借款人同意：出借人及${companyName}和鼎轩资产管理（上海）有限公司有权将借款人的违约相关信息予以公开披露；如借款人存在涉嫌欺诈及上述5.2款载明的违法犯罪行为的，出借人及${companyName}和鼎轩资产管理（上海）有限公司亦有权向相关国家司法机关报案，以追究其刑事责任。<br />
  
  <strong>第七条 借款人联系方式变更通知 </strong><br />
  ...
  7.2 因借款人不提供或不及时提供上述变更信息而导致出借人损失的，包括但不限于调查费用、仲裁费用、律师费用及差旅费用等，概由借款人承担。 <br />
  <strong>第八条 债权转让通知</strong><br />
&nbsp; &nbsp; &nbsp; 出借人有权将借款文件项下的债权向他人转让，此等转让一经发生即可生效，借款人确认无条件认可出借人的转让行为，且同意向债权受让人继续履行本协议的后续还款义务。 <br />
  <strong>第九条 法律适用和争议解决</strong><br />
&nbsp; &nbsp; &nbsp; 本声明书及其附件的签订、履行、终止、解释和争议解决均适用中国法律。 <br />
&nbsp; &nbsp; &nbsp; 如发生争议和纠纷，各方应友好协商解决，协商不成的任一一方有权向${companyName}住所地人民法院提起诉讼。 <br />
  <strong>第十条	征信信息说明</strong><br />
&nbsp; &nbsp; &nbsp; 借款人同意授权${companyName}与鼎轩资产管理（上海）有限公司依据《征信业管理条例》及相关法律法规，自行或者委托第三方征信机构，合法调查了解借款人信用信息，并向第三方征信机构提交借款人在借款业务中产生的相关信息，包括借款人基本信息、借款申请信息、借款合同信息以及还款行为信息等，并记录在该征信机构的信用信息数据库中。 <br />
  <strong>第十一条	其他条款</strong><br />
11.1 本文件自借款人签署时成立，自出借人的出借款项支付到借款人账户时生效。<br />
11.2 借款人确认已知悉${companyName}和鼎轩资产管理（上海）有限公司运营规则并承诺遵守。<br />
...
借款人按照本声明书的约定圆满履行其所有义务,本声明书及其附件（如有）自动终止。<br />
11.6 本借款声明书为编号为<u>  ${contract.contractNo}-01  </u>的融资服务协议之附件，与其具有同等法律效力。<br />
11.7 借款人按照本声明书的约定圆满履行其所有义务,本声明书及其附件（如有）自动终止。</p>
  <br />
<p align="right">
  声明人（借款人）签字：<u>       &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;     </u>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<br /> 
