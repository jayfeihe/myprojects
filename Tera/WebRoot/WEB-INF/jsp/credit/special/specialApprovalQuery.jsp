...
<html>
	...
	<div id="specialTable" class="easyui-tabs" data-options="fit:true">
	<div title="特殊审批"> 
	<div id="main">  
			<div id="part1" class="part">
				<p class="title"><a href="javascript:void(0);">信用借款特殊件审批查询</a></p>

				<div class="content">
					<form id="queryForm" action="credit/special/list.do" method="post" target="queryContent">
						<table>
							<tr>
								<td>申请编号:</td>
...
function addTab(title, url){
    if ($('#specialTable').tabs('exists', title)){
        $('#specialTable').tabs('select', title);
    } else {
        var content = '<iframe scrolling="auto" frameborder="0"  src="'+url+'" style="width:100%;height:100%;"></iframe>';
        $('#specialTable').tabs('add',{
            title:title,
            content:content,
            closable:true
        });
...
//提交后，删除当前选项卡
function removeTab(){
    var tab = $('#specialTable').tabs('getSelected');
    var tabIndex=$('#specialTable').tabs('getTabIndex',tab);
    $('#specialTable').tabs('close',tabIndex);
