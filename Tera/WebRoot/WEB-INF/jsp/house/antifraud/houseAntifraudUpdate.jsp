...
<%--								class="textbox easyui-validatebox"  value="${bean.period}" editable="false" style="width:128px;" disabled="disabled"/>个月</td>--%>
			 	...
			 	<tr><td>
			 		<table id="verifyInfo">
			 			<tr>
							<td align="right">借款金额:</td>
							<td><input id="amount" name="decision.amount" value="${houseVerify.amount/10000}" type="text"
									data-options="validType:['length[0,30]']"
									class="textbox easyui-validatebox" style="width:128px;"/>万元
							</td>
<%--							<td align="light">借款期限:</td>--%>
<%--							<td ><input id="period" name="decision.period" value="${houseVerify.period}" type="text" data-options="validType:['length[0,10]']" --%>
...
<%--							</td>--%>
							...
							<td align="right">产品：
								<input id="product" name="decision.product" value="${houseVerify.product}" type="text" 
						...
						<tr>
							...
							<td>
								<select id="decision" name="decision.decision" value="${houseVerify.decision}"
										...
										<option value="00" <c:if test="${'00' eq houseVerify.decision}">selected</c:if>>不通过</option>
							...
							<td align="right" colspan="4">
								<div id ="noPassReasonDiv">
									...
									value="${houseVerify.returnMsg}" type="text"
									data-options="validType:['length[0,30]']"
						...
						<tr>
							...
							style="resize: none;width:625px;height:50px!important;">${houseVerify.remarks}</textarea></td>
						</tr>
						<tr>
							<td colspan="6">
...
<%--						<tr>--%>
						<tr>
							...
							<td><input id="submitInfo" name="houseAntifraud.submitInfo" type="text" data-options="validType:['length[0,500]']" 
								class="textbox easyui-validatebox" value="${houseAntifraud.submitInfo}" editable="false"/></td>
							<td>提交时间 :</td>
							<td><input id="createTimeStr" name="houseAntifraud.createTimeStr" type="text" data-options="validType:['length[0,30]']" 
								class="textbox easyui-datetimebox" value="${houseAntifraud.createTimeStr}" editable="false"/></td>
						</tr>
						<tr>
							<td>
								<input type="hidden" name="appId" value="${bean.appId}" />
...
function submitRelieveAntifraud(buttonType){
	...
	$.ajax({
		type : "POST",
		url : "<%=basePath%>house/antifraud/relieveAntifraud.do",
