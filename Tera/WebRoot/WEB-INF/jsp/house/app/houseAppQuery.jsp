	...
	<body>
		<div id="main">
			<div id="part1" class="part">
				<p class="title"><a href="javascript:void(0);">房贷申请查询</a></p>

				<div class="content">
					<form id="queryForm" action="house/app/list.do" method="post" target="queryContent">
						<table>
							<tr>
								<td>申请编号:</td>
...
function assignStaff(){
		...
		$.ajax( {
			type : "POST",
			url : "house/app/updateStaffNo.do",
