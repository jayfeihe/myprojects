	...
	<body>
		<div id="main">
			<div id="part1" class="part">
				<p class="title"><a href="javascript:void(0);">房贷放款查询</a></p>

				<div class="content">
					<form id="queryForm" action="house/lending/list.do" method="post" target="queryContent">
						<table>
							<tr>
								<td>申请编号:</td>
...
/*
	//填充当前审批人
	var tsurl="sys/user/listUserByOrgAndRole.do?orgId=${login_org.orgId}&roleNames=房贷放款专员";
