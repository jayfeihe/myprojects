	...
	<body>
		<div id="main">
			<div id="part1" class="part">
				<p class="title"><a href="javascript:void(0);">房贷推送查询</a></p>

				<div class="content">
					<form id="queryForm" action="house/push/list.do" method="post" target="queryContent">
						<table>
							<tr>
								<td>申请编号:</td>
								<td>
...
$(document).ready(function() {
	...
	$('#platformName').combobox({
		...
		panelHeight:'auto',
 		onChange: function(newValue, oldValue){             
            ...
            var product1url = "product/hedao/listjason.do?type=5&belongChannel=" + encodeURI(newValue);
	...
	//填充select数据 产品
 	...
 	var product1url = "product/hedao/listjason.do?type=5&belongChannel=" + encodeURI(belongChannel);
	$("#product1").combobox("clear");
	$('#product1').combobox({
		url:product1url,
		valueField:'name', 
