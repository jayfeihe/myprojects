	...
	<body>
		<div id="main">
			<div id="part1" class="part">
				<p class="title"><a href="javascript:void(0);">房贷查询</a></p>

				<div class="content">
					<form id="queryForm" action="house/repelLoan/list.do" method="post" target="queryContent">
						<table>
							<tr>
								<td>申请编号:</td>
...
$(document).ready(function() {
	...
	//填充select数据 产品
	tsurl="product/hedao/listjason.do?type=5&belongChannel=JM";
