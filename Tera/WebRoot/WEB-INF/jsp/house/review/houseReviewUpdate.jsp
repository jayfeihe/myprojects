										...
										<hr width="100%" size=2 color="#D3D3D3" noshade>
											<table>
												<tr>
													...
													<td>退回原因：</td>
													<td>
														<textarea id="backMsg" name="backMsg" value="${houseVerify.returnMsg}" class="textbox easyui-validatebox"
															data-options="validType:['length[0,500]']" 
															style="resize: none;width:600px;height:50px !important;vertical-align:middle;">${houseVerify.returnMsg}</textarea>
													</td>
												</tr>
												<tr>
													<td colspan="4">
...
function updateFunction(buttonType) {
	...
	$.ajax({
		type : "POST",
		url : "<%=basePath%>" + "house/review/save.do",
...
*/
	var tsurl = "product/hedao/listjason.do?type=5";
