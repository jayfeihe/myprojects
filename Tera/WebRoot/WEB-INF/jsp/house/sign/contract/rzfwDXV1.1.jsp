...
<c:if test="${bean.marriage!='02'}">
<strong>家庭联系人（或紧急联系人）：</strong><u>               ${houseContact.name}                 </u> <br />
  与甲方关系：<u>               是第${houseContact.relation}类                 </u>（1、父母，2、配偶，3、子女，4、亲属，5、朋友，6、同事，7、同学，8、邻居，9、其他）<br />
  年龄：<u>               ${houseContact.age}                 </u><br />
  工作单位：<u>               ${houseContact.comName}                 </u><br />
  联系方式：<u>               ${houseContact.mobile}                 </u><br />
</c:if>
