	...
	<tr>
 	...
 	<tr>
	 	...
	 	<table>
		 	<tr>
				<td>姓名:</td>
				<td><input id="name" name="houseApp.name" type="text" data-options="validType:['length[0,50]']" 
					class="textbox easyui-validatebox" value="${bean.name}"/></td>
				<td><%--证件类型:默认身份证<input id="idType" name="houseApp.idType" type="hidden" value="01"/>--%>
				证件号码:</td>
				<td><input id="idNo" name="houseApp.idNo" type="text" data-options="validType:['idcard']"
			...
			<tr>
				...
				<td>婚姻状况:</td>
				<td><input id="marriage" name="houseApp.marriage" type="text" data-options="validType:['length[0,2]']" 
				class="easyui-combobox" value="${bean.marriage}" editable="false"/></td>
			</tr>
			<tr>
				<td>居住性质:</td>
				<td><input id="addNature" name="houseApp.addNature" type="text" data-options="validType:['length[0,10]']" 
				class="easyui-combobox" value="${bean.addNature}" editable="false"/></td>
				<td>担任职务:</td>
				<td><input id="comDuty" name="houseApp.comDuty" type="text" data-options="rvalidType:['length[0,50]']" 
...
<%--					class="textbox easyui-validatebox" value="${creditReport.defaultAmount}"/></td>--%>
				...
				<tr>
					<td>月还款额:</td>
					<td><input id="monthlyPayments" name="houseApp.monthlyPayments" type="text" editable="false"  data-options="min:0,precision:2" 
