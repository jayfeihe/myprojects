		...
		<div class="content">
			<table>
				...
				<tr>
					...
					<td>证件编号:</td>
					<td><input value="${bean.idNo}" disabled="disabled" id="idNo" onblur="getCustomer();" name="idNo" type="text" data-options="required:true,validType:['length[0,18]','idNo']" class="textbox easyui-validatebox" /></td>
					<td>申请类型:</td>
				...
				<tr>
					...
					<td>财务负责人:</td>
					<td><input   value="${bean.cfoName}"  disabled="disabled" id="cfoName" name="cfoName" type="text" data-options="required:true,validType:['length[0,50]']" class="textbox easyui-validatebox" /></td>
					<td>手机号:</td>
