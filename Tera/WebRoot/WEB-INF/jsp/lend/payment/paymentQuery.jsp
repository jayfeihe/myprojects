...
<body>
	...
	<div id="part1" class="part">
		<p class="title"><a href="javascript:void(0);">支付查询</a></p>
		
		<div class="content">
			<form id="queryForm" action="payment/list.do" method="post" target="queryContent">
				<table>
					<tr>
						<td>合同号/申请号:</td>
						<td><input id="contractNo" name="contractNo" type="text" data-options="validType:['length[0,25]']" class="textbox easyui-validatebox"/></td>
						<td>科目:</td>
						<td><input id="subject" name="subject" type="text" data-options="validType:['length[0,20]']" class="textbox easyui-validatebox"/></td>
					</tr>
					<tr>
						<td>
