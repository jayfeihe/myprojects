...
<body>
	...
	<div id="part1" class="part">
		<p class="title"><a href="javascript:void(0);">抵押借款申请查询</a></p>
		
		<div class="content">
			<form id="queryForm" action="loan/app/list.do" method="post" target="queryContent">
				<table>
					<tr>
						...
						<td><input id="orgId" name="orgId" type="text"
								class="easyui-combobox" style="" editable="false"  />
						</td>
					...
					<tr>
						...
						<td><input id="createTimeMin" name="createTimeMin" style="width: 90px;"  type="text" editable="false"
								...
								至
							<input id="createTimeMax" name="createTimeMax" style="width: 90px;" type="text" editable="false"
								data-options=""
								class="textbox easyui-datebox"   />
...
//添加
function add(param){
	window.location = "<%=basePath%>" + "loan/app/update.do?paramVal="+param;
