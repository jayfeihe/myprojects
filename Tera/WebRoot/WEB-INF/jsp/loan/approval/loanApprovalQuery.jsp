...
<body>
	...
	<div id="part1" class="part">
		<p class="title"><a href="javascript:void(0);">总部审批查询</a></p>
		
		<div class="content">
			<form id="queryForm" action="loan/approval/bpmlist.do" method="post" target="queryContent">
				<table>
							<tr>
