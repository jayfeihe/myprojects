...
<body>
	...
	<div id="part1" class="part">
		<p class="title"><a href="javascript:void(0);">抵押借款复核查询</a></p>
		
		<div class="content">
<!--			<form id="queryForm" action="loan/checkagain/bpmlist.do" method="post" target="queryContent">-->
			<form id="queryForm" action="loan/checkagain/list.do" method="post" target="queryContent">
				<table>
							<tr>
