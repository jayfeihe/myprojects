...
<body>
	...
	<div id="part1" class="part">
		<p class="title"><a href="javascript:void(0);">营业部审批查询</a></p>
		
		<div class="content">
			<form id="queryForm" action="loan/departverify/list.do" method="post" target="queryContent">
						<table>
							<tr>
