	...
	<body>
		<div id="main">
			<div id="part1" class="part">
				<p class="title">
					<a href="javascript:void(0);">抵押借款放款查询</a>
				</p>

				<div class="content">
					<form id="queryForm" action="loan/lending/list.do" method="post"
						target="queryContent">
						<table>
							<tr>
								<td class="td01">姓名/机构全称:</td>
								<td><input id="loanName" name="loanName" type="text"
										data-options="validType:['length[0,50]']"
										class="textbox easyui-validatebox"/></td>
								<td class="td01">借款金额:</td>
								<td><input id="loanAmountMin" name="loanAmountMin" style="width: 90px;" type="text" editable="false"
										data-options="min:0,precision:2"
										class="textbox easyui-numberbox" />
									至
									<input id="loanAmountMax" name="loanAmountMax" style="width: 90px;" type="text" editable="false"
										data-options="min:0,precision:2"
										class="textbox easyui-numberbox" />
								</td>
								<td class="td01">机构:</td>
							...
							<tr>
								...
								<td class="td01">签约时间:</td>
								<td><input id="signDateBegin" name="signDateBegin" style="width: 90px;"  type="text" editable="false"
										data-options=""
										class="textbox easyui-datebox" />
										至
									<input id="signDateEnd" name="signDateEnd" style="width: 90px;" type="text"
										data-options=""
							...
							<tr><td colspan="8"><input type="button" value="查询" class="btn"
