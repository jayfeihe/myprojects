...
<body>
	...
	<div id="part1" class="part">
		<p class="title"><a href="javascript:void(0);">人工撮合收费查询</a></p>
		<div class="content">
<!--		<form id="queryForm" action="loan/manualfee/loan2matchList.do" method="post" target="queryContent">-->
			<form id="queryForm" action="loan/manualfee/list.do" method="post" target="queryContent">
				<table>
					<tr>
						<td>
							借款申请号:
						...
						<td>所属机构:</td>
						<td>
							<input id="orgId" name="orgId" type="text" editable="false" class="easyui-combobox" data-options="validType:['length[0,50]']" class="textbox easyui-validatebox"value="${bean.orgId}"/>
						</td>
					</tr>
					<tr>
						<td>
