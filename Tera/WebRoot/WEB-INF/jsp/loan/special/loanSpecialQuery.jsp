...
<body>
	...
	<div id="part1" class="part">
		<p class="title"><a href="javascript:void(0);">抵押借款特殊件审批查询</a></p>
		
		<div class="content">
<!--		<form id="queryForm" action="loan/special/bpmlist.do" method="post" target="queryContent">-->
			<form id="queryForm" action="loan/special/list.do" method="post" target="queryContent">
				<table>
							<tr>
