...
<!--
html{height:100%;}
body{font-family:Arial, Helvetica, sans-serif;background: url('img/201407062330.png') center no-repeat;height: 100%;}
	...
	<div class="main-container">
		<div class="t-m">
			...
			<div class="footer-info" style="">
				<div> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;版权所有：北京天瑞兴隆科技发展有限公司 京ICP备：201104217. 建议使用IE9.0以上浏览器.</div>
			</div>
		</div>
	</div>
