...
<body>
	...
	<div id="part1" class="part">
		...
		<div class="content">
			<form id="queryForm" action="renhang/queryDetail/list.do" method="post" target="queryContent">
				<table>
					<tr>
<td>申请ID:</td>
...
<tr>
<td>查询ID:</td>
<td><input id="queryId" name="queryId" type="text" data-options="min:0,precision:0" class="textbox easyui-numberbox"/></td>
</tr>
<tr>
<td>查询日期:</td>
<td><input id="queryDate" name="queryDate" type="text" editable="false" class="textbox easyui-datebox"/></td>
</tr>
<tr>
<td>查询操作员:</td>
<td><input id="queryOperator" name="queryOperator" type="text" data-options="validType:['length[0,50]']" class="textbox easyui-validatebox"/></td>
</tr>
<tr>
<td>查询原因:</td>
<td><input id="queryReason" name="queryReason" type="text" data-options="validType:['length[0,50]']" class="textbox easyui-validatebox"/></td>
</tr>
<tr>
<td>备注:</td>
