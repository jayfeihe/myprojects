...
<tr>
<td>查询ID:</td>
<td><input id="queryId" name="queryId" type="text" editable="false"  data-options="min:0,precision:0" class="textbox easyui-numberbox" value="${bean.queryId}"/></td>
</tr>
<tr>
<td>查询日期:</td>
<td><input id="queryDate" name="queryDate" type="text" editable="false" class="textbox easyui-datebox" value="${bean.queryDateStr}"/></td>
</tr>
<tr>
<td>查询操作员:</td>
<td><input id="queryOperator" name="queryOperator" type="text" data-options="validType:['length[0,50]']" class="textbox easyui-validatebox" value="${bean.queryOperator}"/></td>
</tr>
<tr>
<td>查询原因:</td>
<td><input id="queryReason" name="queryReason" type="text" data-options="validType:['length[0,50]']" class="textbox easyui-validatebox" value="${bean.queryReason}"/></td>
</tr>
<tr>
<td>备注:</td>
...
function updateFunction() {
	...
	$.ajax({
		type : "POST",
		url : "<%=basePath%>" + "renhang/queryDetail/save.do",
...
//	                var url= "<%=basePath%>" + "renhang/queryDetail/query.do";
//					window.location=url;
					window.history.go(-1);
            	});
            } else {				
