		...
		<div class="content">
			<form id="updateForm" >
				<table>
					...
					<tr>
<td>组织代码:</td>
<td><input id="departCode" name="departCode" type="text" data-options="validType:['length[0,100]']" class="textbox easyui-validatebox" value="${bean.departCode}"/></td>
</tr>
<tr>
<td>组织名称:</td>
<td><input id="departName" name="departName" type="text" data-options="validType:['length[0,30]']" class="textbox easyui-validatebox" value="${bean.departName}"/></td>
</tr>
<tr>
<td>说明:</td>
...
<tr>
<td>排序:</td>
<td><input id="orderNum" name="orderNum" type="text" editable="false"  data-options="min:0,precision:0" class="textbox easyui-numberbox" value="${bean.orderNum}"/></td>
</tr>
<tr>
<td>操作员:</td>
...
<tr>
<td>父组织ID:</td>
<td><input id="parentId" name="parentId" type="text" editable="false"  data-options="min:0,precision:0" class="textbox easyui-numberbox" value="${bean.parentId}"/></td>
</tr>
