							...
							<div class="loginform">
								<form method="post" action="login.do" name="LoginForm">
									...
									<tr>
										...
										<td><input class="easyui-validatebox textbox" data-options="required:true" style="height:28px !important;padding:0px 5px 0px 25px;width:220px;background:url(img/list02.png) 6px 6px no-repeat;" type="password" id="password" name="password" title="请输入密码" value="" tabindex=3 placeholder="请输入密码"/></td>
									</tr>
									<tr>
...
$(document).ready(function (){
	...
	$("input[class='combo-text validatebox-text']").attr("placeholder","请选择机构");
	orgList();
});
