...
<body>
	...
	<div id="part1" class="part">
		<p class="title"><a href="javascript:void(0);">数据权限查询</a></p>
		...
		<div class="content">
			<form id="queryForm" action="sys/org/list.do" method="post" target="queryContent">
				<table>
					<tr>
						<td>数据权限代码:</td>
						<td><input id="orgId" name="orgId" type="text" data-options="validType:['length[0,18]']" class="textbox easyui-validatebox"value="${bean.orgId}"/></td>
