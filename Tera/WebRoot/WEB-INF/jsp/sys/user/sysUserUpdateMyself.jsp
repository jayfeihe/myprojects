								...
								<tbody>
									...
									<tr>
										...
										<td><input id="password_id" name="password" type="password"
												...
												class="textbox easyui-validatebox" value="${data.password }" /></td>
										<td>重复密码:</td>
										<td><input id="confirm_password_id" name="confirm_password" type="password"
												...
												invalidMessage="两次输入密码不匹配" value="${data.password }" /></td>
									</tr>
									<tr>
										<td>姓名:</td>
										<td><input id="name_id" name="name" type="text"
									...
									<tr>
										<td>电邮:</td>
										<td><input id="email_id" name="email" type="text" class="txt" value="${data.email }" /></td>
									</tr>
									<tr>
										<td colspan="2">
