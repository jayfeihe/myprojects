...
<body>
	...
	<div id="part1" class="part">
		<p class="title"><a href="javascript:void(0);">${tableComment}查询</a></p>
		
		<div class="content">
			<form id="queryForm" action="${jspPath}/list.do" method="post" target="queryContent">
				<table>
					${jspQueryTr}
					<tr>
						<td>
