...
import ${bizzPackage}.entity.${modelPackage}.${className};
import ${bizzPackage}.page.${modelPackage}.${className}Page;
import ${bizzPackage}.service.${modelPackage}.${className}Service;
import ${bizzPackage}.dao.${modelPackage}.${className}Dao;
