...
public class BusinessConstants {
	...
	/**借款人婚姻--未婚*/
	public static final String CAR_APP_MARRIAGE_N = "01";
	/**借款人婚姻--已婚*/
	public static final String CAR_APP_MARRIAGE_Y = "02";
	...
	/**查重类型--单位名称*/
	public static final String CAR_REPEAT_TYPE_COM_NAME = "1";
	/**查重类型--单位地址*/          
	public static final String CAR_REPEAT_TYPE_COM_ADD = "2";
	/**查重类型--居住地址*/          
	public static final String CAR_REPEAT_TYPE_HOME_ADD = "3";
	/**查重类型--联系方式*/          
	public static final String CAR_REPEAT_TYPE_CONTACT = "4";
	/**查重类型--身份证*/            
	public static final String CAR_REPEAT_TYPE_ID_NO = "5";
	...
	/**面审调查来源--信用报告*/
	public static final String INTERVIEW_SOURCE_CAR_REPORT = "05";
	...
	/**信审欺诈状态--未解决*/
	public static final String CAR_FRAUD_STATE_NOT_OK = "1";
	/**信审欺诈状态--已解决*/
	public static final String CAR_FRAUD_STATE_OK = "2";
}
