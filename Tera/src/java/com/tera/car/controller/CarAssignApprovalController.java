 ...
 */
@Controller
@RequestMapping("/car/assign/approval")
public class CarAssignApprovalController  extends BaseController{

	/**
	 * 日志
	 */
	private final static Logger log = Logger.getLogger(CarAssignApprovalController.class);
	...
	public String assignApprovalQuery(HttpServletRequest request, ModelMap map) throws Exception {
		...
		return "car/assign/approval/assignQuery";
	}
	...
	public String assignApprovalList(CarQBean qBean,HttpServletRequest request, ModelMap map) throws Exception {
		...
		map.put("pm", pm);
		log.info(thisMethodName+":end");
		return "car/assign/approval/assignList";
	}
