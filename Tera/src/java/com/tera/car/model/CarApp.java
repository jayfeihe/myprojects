...
public class CarApp {
	 ...
	 * 新增字段
	 */
	private double fineAmount; //车辆罚款金额 
	private String deductedFraction; //车辆罚扣分数
	private String vehicleConditionRate; //车况评级
	private double assessAmount; //评估金额
	private String assessUid; //评估师
	...
	//--------为审批添加，显示审核信息----------
	private String carDecisionCode;//结果
	private String carDecisionOperator;//操作人
	...
	public String getCarDecisionCode() {
		return carDecisionCode;
	}
	public void setCarDecisionCode(String carDecisionCode) {
		this.carDecisionCode = carDecisionCode;
	}
	public String getCarDecisionOperator() {
		return carDecisionOperator;
	}
	public void setCarDecisionOperator(String carDecisionOperator) {
		this.carDecisionOperator = carDecisionOperator;
	}
	...
	public String getDeductedFraction() {
		return deductedFraction;
	}
	public void setDeductedFraction(String deductedFraction) {
		this.deductedFraction = deductedFraction;
	}
	public String getVehicleConditionRate() {
		return vehicleConditionRate;
	}
	public void setVehicleConditionRate(String vehicleConditionRate) {
		this.vehicleConditionRate = vehicleConditionRate;
	}
	...
	public String getAssessUid() {
		return assessUid;
	}
	public void setAssessUid(String assessUid) {
