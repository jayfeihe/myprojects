...
public class CarInterview {
	...
	//电话拨打记录
	private List<CarCallLog> callLogList=new ArrayList<CarCallLog>();
	...
	public List<CarCallLog> getCallLogList() {
		return callLogList;
	}
	public void setCallLogList(List<CarCallLog> callLogList) {
