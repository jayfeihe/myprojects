...
@Service("carAppHandlerService")
public class CarAppHandlerService {
	 ...
	 * @throws Exception
	 */
	public String getGradeRemind(CarApp carApp) throws Exception {
		// 判断性别
		...
		imgMap.put("appId", carApp.getAppId());
