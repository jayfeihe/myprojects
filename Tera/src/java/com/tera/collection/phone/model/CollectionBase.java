...
public class CollectionBase {
	...
	private String gender;//性别 add by wangyongliang 20150611
	private String orgName; //营业部name add by wangyongliang 20150611
	private String minLateDays; //逾期最小范围值 add by wangyongliang 20150611
	private String maxLateDays; //逾期最大范围值 add by wangyongliang 20150611
	...
	public java.sql.Timestamp getHelpFollowTime () {
		return this.helpFollowTime;
	}
	//getter部分,Timestamp类型的修改获取String的方法
	public String getHelpFollowTimeStr () {
		return DateUtils.formatTime(this.helpFollowTime);
	}
