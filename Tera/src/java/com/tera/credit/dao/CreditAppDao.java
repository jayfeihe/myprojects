...
public interface CreditAppDao {
	...
	public void add(CreditApp obj);	
	
	public void update(CreditApp obj);
	
	public void updateOnlyChanged(CreditApp obj);
		
	public void delete(int obj);

	public int queryCount(Map<String, Object> map);
	
	public List<CreditApp> queryList(Map<String, Object> map);

	public CreditApp queryByKey(Object obj);
	 ...
	 * @return
	 */
	public List<CreditApp> queryBpmLoanAppList(Map<String, Object> map);
	 ...
	 * @return
	 */
	public List<CreditApp> queryBpmAppAndContractList(Map<String, Object> map);
	...
	public List<CreditApp> getSaleReTimeFreezeList(CreditApp obj);
