...
public class CreditApp {
	...
	//--------为审批添加，显示审核信息----------
	private String creditDecisionCode;//结果
	private String creditDecisionOperator;//操作人
	...
	public String getCreditDecisionOperator() {
		return creditDecisionOperator;
	}
	public void setCreditDecisionOperator(String creditDecisionOperator) {
		this.creditDecisionOperator = creditDecisionOperator;
	}
