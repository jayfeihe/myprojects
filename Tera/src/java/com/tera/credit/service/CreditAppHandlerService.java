...
@Service("creditAppHandlerService")
public class CreditAppHandlerService {
	 ...
	 * @throws Exception
	 */
	public String getGradeRemind(CreditApp creditApp) throws Exception {
		// 判断性别
		...
		imgMap.put("appId", creditApp.getAppId());
