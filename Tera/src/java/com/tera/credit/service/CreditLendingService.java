 ...
 * <b>版权所有：<b>天瑞兴隆<br>
 */
@Service("creditLendingService")
public class CreditLendingService {

	private final static Logger log = Logger.getLogger(CreditLendingService.class);
	 ...
	 * @param bean			   申请
	 * @param contract		   合同
	 * @param creditDecision 决策
	 * @param loginId
	 * @param orgId
	 * @throws Exception
	 */
	@Transactional
	public ResultObj confirmLending(CreditApp bean,Contract contract,CreditDecision creditDecision,String loginId,String orgId)throws Exception{
		...
		//放款金额
		double fkAmount=creditDecision.getAmount();
		//风险金
...
//			contract.setChannelType("3");// MD
		...
		creditAppService.updateOnlyChanged(bean);	//更新 申请 状态
...
//		fmap.put("type", "0");
	 ...
	 */
	@Transactional
	public void backReview(CreditApp bean,String loginId, String msg)throws Exception{
		Timestamp ts = new Timestamp(System.currentTimeMillis()); 
		bean.setState("18");
		bean.setOperator(loginId);
		bean.setUpdateTime(ts);
	...
	public ResultObj jimuBoxLending(String appId,String loginId,String orgId) throws Exception{
    		...
    		List<CreditApp> appList  = creditAppService.queryList(paMap);
    		//得到申请
    		...
    		//调用 积木盒子 连接请求
    		return jmboxService.reqJmBox(creditApp, decision, contract, loginId, orgId);
	}
	 ...
	 */
	@Transactional
	public void jMErrorconfirmLending(CreditApp bean,Contract contract,CreditDecision creditDecision,
...
//		fmap.put("type", "0");
    	...
    	//更新合同
    	contract.setChannelType(creditDecision.getBelongChannel());
	 ...
	 */
	@Transactional
	public void manualJMLendOk(Contract contract,CreditDecision creditDecision,Date channelDate,String orgId,String loginId) throws Exception{
		//放款成功，更新 合同
