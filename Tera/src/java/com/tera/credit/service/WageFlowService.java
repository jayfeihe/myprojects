...
import com.tera.credit.dao.WageFlowDao;
 ...
 * <b>版权所有：<b>天瑞兴隆<br>
 */
@Service("wageFlowService")
public class WageFlowService {

	private final static Logger log = Logger.getLogger(WageFlowService.class);

	@Autowired(required=false)
    private WageFlowDao dao;
