 ...
 */
@Controller
@RequestMapping("/house/assign/approval")
public class HouseAssignApprovalController  extends BaseController{

	/**
	 * 日志
	 */
	private final static Logger log = Logger.getLogger(HouseAssignApprovalController.class);
	...
	public String assignApprovalQuery(HttpServletRequest request, ModelMap map) throws Exception {
		...
		return "house/assign/approval/assignQuery";
	}
	...
	public String assignApprovalList(HouseQBean qBean,HttpServletRequest request, ModelMap map) throws Exception {
		...
		map.put("pm", pm);
		log.info(thisMethodName+":end");
		return "house/assign/approval/assignList";
	}
