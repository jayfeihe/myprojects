 ...
 * 
 * 信用贷款决策表实体类
 * <b>功能：</b>houseDecision<br>
 * <b>作者：</b>CodeGenerater<br>
 * <b>日期：</b>2014-09-04 12:02:13<br>
 * <b>版权所有：<b>天瑞兴隆<br>
 */
public class HouseDecision {
	...
	/**决策类型-核价审核*/
	public static final String TYPE_PRICE = "4";
	/**决策类型-最终决策*/
	public static final String TYPE_END = "0";
	/**决策类型-审核*/
	public static final String TYPE_VERIFY = "1";
	/**决策类型-审批*/
	public static final String TYPE_APPROVAL = "2";
	/**决策类型-特殊审批*/
	public static final String TYPE_SPACIAL_APPROVAL = "3";
}
