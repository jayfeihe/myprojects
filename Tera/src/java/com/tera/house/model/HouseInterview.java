...
public class HouseInterview {
	...
	//电话拨打记录
	private List<HouseCallLog> callLogList=new ArrayList<HouseCallLog>();
	...
	public List<HouseCallLog> getCallLogList() {
		return callLogList;
	}
	public void setCallLogList(List<HouseCallLog> callLogList) {
