...
public class SpecialApprovalFBean {
	...
	private String houseApprovalOperator;      // 审批决策人
	...
	public String getHouseApprovalOperator() {
		return houseApprovalOperator;
	}
	public void setHouseApprovalOperator(String houseApprovalOperator) {
		this.houseApprovalOperator = houseApprovalOperator;
	}
