...
import com.tera.house.dao.HouseCreditReportDao;
 ...
 * <b>版权所有：<b>天瑞兴隆<br>
 */
@Service("houseCreditReportService")
public class HouseCreditReportService {

	private final static Logger log = Logger.getLogger(HouseCreditReportService.class);

	@Autowired(required=false)
    private HouseCreditReportDao dao;
