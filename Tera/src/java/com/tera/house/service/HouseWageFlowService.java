...
import com.tera.house.dao.HouseWageFlowDao;
 ...
 * <b>版权所有：<b>天瑞兴隆<br>
 */
@Service("houseWageFlowService")
public class HouseWageFlowService {

	private final static Logger log = Logger.getLogger(HouseWageFlowService.class);

	@Autowired(required=false)
    private HouseWageFlowDao dao;
