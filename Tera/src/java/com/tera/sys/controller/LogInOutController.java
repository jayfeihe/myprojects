...
public class LogInOutController {
	...
	public String goLogin(String loginid, String password, String orgId, String rand, HttpServletRequest request,
...
//			if(!"1".equals(user.getState())){
			...
			if (1 == user.getIsAdmin()) {
				...
				menus=menuService.getMenuByOrgAndUser(user.getId(),org.getId());
