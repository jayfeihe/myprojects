...
//		System.out.println("frozenColumn="+frozenColumn);
//
//		System.out.println("frozenRow="+frozenRow);
...
//		System.out.println("colIndex="+colIndex+"$$$$valueLength="+valueLength);
		if (valueLength > 15) {
			valueLength = 15;
		}
		short colW = (short) (valueLength * per + excel);
//		System.out.println("colIndex="+colIndex+"$$$$valueLength="+
//				valueLength+"$$$$$$colW="+colW+"$$$$$columnWidth="+columnWidth);
		if (colW > columnWidth) {
