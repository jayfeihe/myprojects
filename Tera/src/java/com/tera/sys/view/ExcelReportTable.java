...
public class ExcelReportTable implements ReportTable {
	...
	/** (non-Javadoc)
	 * @see com.tera.sys.view.ReportTable#getTitle()
	 * @return String
	 */
	...
	/** (non-Javadoc)
	 * @see com.tera.sys.view.ReportTable#getCellHeight(int, int)
	 * @param row row
	 * @param column column
	 * @return int
	 */
	...
	/** (non-Javadoc)
	 * @see com.tera.sys.view.ReportTable#getCellWidth(int, int)
	 * @param row row
	 * @param column column
	 * @return int
	 */
...
//			}
	...
	/** (non-Javadoc)
	 * @see com.tera.sys.view.ReportTable#getColumnCount()
	 * @return 列数
	 */
	...
	/** (non-Javadoc)
	 * @see com.tera.sys.view.ReportTable#getObject(int, int)
	 * @param row 行数
	 * @param column 列数
	 * @return Cell对象
	 */
	...
	/** (non-Javadoc)
	 * @see com.tera.sys.view.ReportTable#getRowCount()
	 * @return 行数
	 */
	...
	/** (non-Javadoc)
	 * @see com.tera.sys.view.ReportTable#isData(int, int)
	 * @param row 行数
	 * @param column 列数
	 * @return 是否数据
	 */
	...
	/** (non-Javadoc)
	 * @see com.tera.sys.view.ReportTable#isCondition(int, int)
	 * @param row 行数
	 * @param column 列数
	 * @return 是否条件
	 */
	...
	/** (non-Javadoc)
	 * @see com.tera.sys.view.ReportTable#isHead(int, int)
	 * @param row 行数
	 * @param column 列数
	 * @return 是否表头
	 */
	...
	/** (non-Javadoc)
	 * @see com.tera.sys.view.ReportTable#isStatistic(int, int)
	 * @param row 行数
	 * @param column 列数
	 * @return boolean
	 */
	...
	/** (non-Javadoc)
	 * @see com.tera.sys.view.ReportTable#isComment(int, int)
	 * @param row 行数
	 * @param column 列数
	 * @return boolean
	 */
	...
	/** (non-Javadoc)
	 * @see com.tera.sys.view.ReportTable#getFrozenColumn()
	 * @return Integer
	 */
	...
	/** (non-Javadoc)
	 * @see com.tera.sys.view.ReportTable#getFrozenRow()
	 * @return Integer
	 */
