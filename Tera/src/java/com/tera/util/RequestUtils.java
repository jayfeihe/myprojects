...
//					}
					field.set(obj, param);
				} else if (java.util.Date.class.equals(field.getType()) || java.sql.Date.class.equals(field.getType())) {
					String param = paraValues[0];
...
//							}
						...
						field.set(obj, list);
					} else if (typeName.contains("java.util.Date") || typeName.contains("java.sql.Date") ) {
