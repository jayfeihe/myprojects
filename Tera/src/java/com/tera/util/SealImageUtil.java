...
public class SealImageUtil {
	...
	public static BufferedImage bufferedImageUtil(String companyName, String centerName, String centerFlowNo,String uuid){
		return bufferedImageUtil(companyName, uuid, centerName, centerFlowNo, 120, 285);
	}
