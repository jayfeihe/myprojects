...
//		$(this).wrap('<div id="' + panId + '" style="width:100%; height:' + height + 'px; overflow:hidden; position: relative;"><div id="' + panMaskId + '" style="left:0px;top:0px;position:relative;"></div></div>');
		...
		$($('div#' + panId).get(0)).mousemove(function(e) {
