...
public class AutoMatchProcessor implements ItemProcessor<Integer, String> {

	/**
	 * 日志
	 */
	private final static Logger log = Logger.getLogger(AutoMatchProcessor.class);
    ...
    public String process(Integer lm) throws Exception {
    	try {
			...
			errorLog.setJobName("autoMatchJob");
