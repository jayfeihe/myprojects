...
public class JMSendDefaultInfoTest {
	...
	public static void main(String[] args) throws Exception {
		...
		JobParameters param = new JobParametersBuilder().addString("timestamp",
				dateParam).toJobParameters();

		JobExecution exec = jobLauncher.run(
				jobRegistry.getJob("JMSendDefaultInfoJob"), param);
	}
