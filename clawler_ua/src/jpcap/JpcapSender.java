...
public class JpcapSender extends JpcapInstance {
	...
	private static JpcapSender RAW_SOCKET_SENDER;
	 ...
	 * @return intstance of this class (JpcapSender)
	 */
	public synchronized static JpcapSender openRawSocket()
			throws java.io.IOException {

		if (RAW_SOCKET_SENDER == null) {
			RAW_SOCKET_SENDER = new JpcapSender();
			RAW_SOCKET_SENDER.nativeOpenRawSocket();
			RAW_SOCKET_SENDER.ID = RAW_SOCKET_ID;
		}

		return RAW_SOCKET_SENDER;
	}
