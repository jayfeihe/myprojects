...
public class AdxApp {
	...
	public JSONObject getAppTypeTag() {
		return appTypeTag;
	}

	public void setAppTypeTag(JSONObject appTypeTag) {
		this.appTypeTag = appTypeTag;
	}
}
