...
<body>
	<div class="panel panel-default">
		<div class="panel-heading">
			<h3 class="panel-title">广告主账号管理</h3>
		</div>
		<div class="panel-body">
			<form role="form" id="queryForm">
				<div class="form-inline">
					<div class="form-group">
						<label for="inputText" class="control-label">广告主账号名称：</label> 
						<input type="text" class="form-control" id="companyName"
							name="companyName" placeholder="广告主账号名称">
					</div>
					<div class="form-group">
		...
		<div style="margin-left: 10px;margin-bottom: 10px;">
			<input type="button" id="addAccountBtn" class="btn btn-primary" value="新增广告主账号">
		</div>
	</div>
			...
			<div class="modal-content"  style="width: 700px;">
				...
				<div class="modal-body">
					<form class="form-horizontal" role="form" id="addForm">
						...
						<div class="form-group">
							<label for="inputText" class="col-sm-2 control-label"><i style="color: red;">*</i> 广告主URL：</label>
							<div class="col-sm-6">
		...
		<div class="modal-dialog" style="width: 700px;">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="myModalLabel">修改广告主账号</h4>
				</div>
				<div class="modal-body">
