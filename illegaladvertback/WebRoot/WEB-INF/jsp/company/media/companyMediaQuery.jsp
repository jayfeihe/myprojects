...
<body>
	<div class="panel panel-default">
		<div class="panel-heading">
			<h3 class="panel-title">媒体管理</h3>
		</div>
		<div class="panel-body">
			<form role="form" id="queryForm">
				<div class="form-inline">
					<div class="form-group">
						<label for="inputText" class="control-label">媒体名称：</label> 
						<input type="text" class="form-control" id="companyName"
							name="companyName" placeholder="媒体名称">
					</div>
					<div class="form-group">
		...
		<div style="margin-left: 10px;margin-bottom: 10px;">
			<input type="button" id="addCompanyBtn" class="btn btn-primary" value="新增媒体">
		</div>
	</div>
		...
		<div class="modal-dialog">
			<div class="modal-content"  style="width: 700px;">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="myModalLabel">新增媒体</h4>
				</div>
				<div class="modal-body">
					<form class="form-horizontal" role="form" id="addForm">
						<input type="hidden" class="form-control" id="type" name="type" value="<%=UserCompany.TYPE_MEDIA%>">
						<div class="form-group">
		...
		<div class="modal-dialog" style="width: 700px;">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="myModalLabel">修改媒体</h4>
				</div>
				<div class="modal-body">
