...
public class GenerateKeyUtil {
	...
	static {
		...
		/**广告主、媒体主键id前缀*/
		SeqCreateVo UCVo = new SeqCreateVo(0, DateUtil.formatDate(DateUtil.getCurDate(), DateUtil.FORMAT_DD_NO_SYMBOL), CommonConstants.PREFIX_USER_COMPANY);
		idHashtable.put(CommonConstants.PREFIX_USER_COMPANY, UCVo);
		
		/**用户账户主键id*/
		SeqCreateVo UAVo = new SeqCreateVo(0, DateUtil.formatDate(DateUtil.getCurDate(), DateUtil.FORMAT_DD_NO_SYMBOL), CommonConstants.PREFIX_USER_ACCOUNT);
		idHashtable.put(CommonConstants.PREFIX_USER_ACCOUNT, UAVo);
	}
	...
	public synchronized static String getSeqId(String prefix, String numbers) {
		...
		String curDate = DateUtil.formatDate(DateUtil.getCurDate(), DateUtil.FORMAT_DD_NO_SYMBOL);
	...
	public synchronized static String getId(String prefix, String dbNum) {
		String strCurDate = DateUtil.formatDate(DateUtil.getCurDate(), DateUtil.FORMAT_SS_NO_SYMBOL);
