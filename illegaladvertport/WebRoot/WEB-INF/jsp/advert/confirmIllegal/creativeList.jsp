...
<input type="hidden" id="curCreativeCount" value="${fn:length(pager.datas) }"/>
<%-- <section id="creative-gallery-wrapper">
	<c:forEach items="${creativeDatas }" var="data">
 ...
 <div id="creativePage">
	<jsp:include page="/WEB-INF/jsp/page.jsp">
		<jsp:param value="Creative" name="type"/>
	</jsp:include>
</div>
--%>

<div id="creativeFall" class="wookmark">
...
$(function(){
	waterfall.init({
		imageParent:'creativeFall',
		container:'confirmCreativeIllegal',
		imageCount:$("#curCreativeCount").val()
	});
})
</script>