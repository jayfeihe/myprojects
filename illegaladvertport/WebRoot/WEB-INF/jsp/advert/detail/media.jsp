...
<body>
	...
	<div class="container-fluid dash index">
			...
			<div class="col-md-12">
				<form class="form-inline" style="text-align: center;" role="form">
					<div class="form-group">
						...
						<input class="form-control big-search"  placeholder="可输入广告名称/创意名称/广告主名称查询" id="keyWord">
					</div>
		...
		<div class="row">
			<div class="col-md-12">
				...
				<p><span class="fsf">违法广告创意数量</span>：<span style="color:red;" id="creativeCount"></span>个</p>
			</div>
		</div>

		<div class="row">
			<div class="col-md-12 addisplay">
				<div class="tab-content illegal2">
					<div role="tabpanel" class="tab-pane active" id="home">
						<form class="form-inline search" role="form" id="mediaForm">
			        		...
			        		<div class="pull-left datePanForm">
					        	...
					        	<div class="datePan" id="datePan">
			                        ...
			                        <div>
				                        <input type="button" class="btn btn-ssp" value="确定" onclick="bindDate('mediaForm');"/>
				                     	<input type="button" class="btn btn-ssp" value="取消" onclick="cancelDate('mediaForm');"/>
			                        </div>
			                    </div>
			        		</div>
							...
							<input type="button" class="btn btn-yellow" value="搜索" onclick="loadMediaIllegal(1)"/>
						</form>
				
						<div id="mediaIllegal"></div>
				...
				<!-- ***************************************对应问号的定位内容开始************************************ -->
				<div class="wen_top" style="position:absolute;background:#ccc;width:250px;height:60px;left:230px;top:-50px;padding:5px 10px;display:none;z-index:9999999999999;border-radius:5px;">
    ...
    <script type="text/javascript" src="<%=basePath%>js/detail/media.js"></script>
    ...
    <script type="text/javascript">
    	$(function(){
    		// 整改初始化
    		feedback.openModel('mediaIllegal');
    		feedback.closeModel();
    		feedback.init('correctConfirmForm');
    		feedback.init('correctedForm');
    		feedback.submitCorrect({'pageType':'3','page':'1'});
