...
<input type="hidden" id="totalCount" value="${fn:length(mediaDatas) }"/>
<%-- <section id="media-gallery-wrapper">
	<c:forEach items="${mediaDatas }" var="data">
