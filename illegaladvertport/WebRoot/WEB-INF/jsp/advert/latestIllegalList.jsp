...
<input type="hidden" id="totalCount" value="${fn:length(latestDatas) }"/>
<%-- <section id="latest-gallery-wrapper">
	<c:forEach items="${latestDatas }" var="data">
