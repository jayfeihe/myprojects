...
public class PartnerUserOrder implements Serializable {
	...
	public void setReceProvinceId(String receProvinceId) {
	...
	public void setReceCityId(String receCityId) {
		this.receCityId = receCityId;
	}

	public String getReceAreaId() {
		return receAreaId;
	}

	public void setReceAreaId(String receAreaId) {
		this.receAreaId = receAreaId;
	}
