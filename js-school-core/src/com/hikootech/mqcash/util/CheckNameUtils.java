...
public class CheckNameUtils {
	...
	public final static String[] surname = {
				...
				"竹","百","福","言","佟","爱","年","笪","谯","哈","墨","召",
				"寸","贰","皇","侨","彤","竭","端","赫","实","甫","集","象",
				"翠","狂","辟","典","良","函","芒","苦","其","京","中","夕",
				"琴","后","况","亢","缑","帅","海","归","赏","伯","佴","佘",
				"牟","开","光","操","瑞","眭","泥","运","摩","伟","铁","迮",
				"盖","逯","库","郏","逢","阴","薄","厉","稽","商","丛","岳",
				"钦","鄢","汝","法","闫","楚","晋","督","仉","蹇","称","诺",
				"来","多","繁","戊","朴","回","毓","之","冠","宾","香","果",
				"西门","东门","左丘","梁丘","南宫","呼延","南门","东郭","微生",
				"百里","谷梁","宰父","夹谷","拓跋","第五","鲜于","锺离","闾丘",
				"壤驷","乐正","漆雕","公西","巫马","端木","颛孙","子车","司寇",
				"亓官","羊舌","公良","段干","万俟","司马","上官","欧阳","夏侯",
				"诸葛","闻人","东方","赫连","皇甫","尉迟","公羊","澹台","公冶",
				"宗政","濮阳","淳于","单于","太叔","申屠","公孙","仲孙","轩辕",
				"令狐","钟离","宇文","长孙","慕容","司徒","司空","章佳","那拉",
				"乌雅","范姜","碧鲁","张廖","张简","图门","太史","公叔","乌孙",
				"完颜","马佳","佟佳","富察","费莫","有","舜","叶赫那拉","依尔根觉罗",
				"依尔觉罗","萨嘛喇","赫舍里","额尔德特","萨克达","钮祜禄","他塔喇","喜塔腊",
				"讷殷富察","叶赫那兰","库雅喇","瓜尔佳","舒穆禄","爱新觉罗","索绰络","纳喇"
				};

	/** 
	* @Title getChineseSurName 
	* @Description TODO(百家姓) 
	* @param 参数列表
	* @return 设定文件 
	* @return String[]	返回类型 
	* @throws 
	...
	*/
	public String getRandomSur(){
		...
		int index=random.nextInt(getChineseSurName().length-1);	
		
		return  getChineseSurName()[index]; //获得一个随机的姓氏
	}
	
	/** 
	* @Title getRandomName 
	* @Description TODO(随机生成姓名) 
	* @param 参数列表
	* @return 设定文件 
	* @return String	返回类型 
	* @throws 
	*/
	public String getRandomName(String sur){
		Random random=new Random(System.currentTimeMillis());
		/* 从常用字中选取一个或两个字作为名 */
		if(random.nextBoolean()){
			sur+=getChinese()+getChinese();
		}else {
			sur+=getChinese();
		}
		return  sur; 
	...
	*/
	...
	public static void main(String[] args) {
		String name = "尔根觉罗依尔觉罗萨嘛喇依尔根觉罗依尔觉罗萨嘛喇";
		for (int i = name.length()-1 ; i < name.length(); i--) {
			String surFirst = name.substring(0, i);
			
			System.out.println(surFirst);
			if (!Arrays.asList(getChineseSurName()).contains(surFirst)) {
