...
public class CipherUtil {
	...
	public static void main(String[] args) throws Exception {
		String key = "12345678";
		String data = "yuwei";
		String str1 = encode(key, data.getBytes());
		System.out.println(str1);
		byte[] bytes = decode(key, Base64.decode(str1));
	...
	{
		try {
			String card=CipherUtil.encryptData("0022222222220131552499","1232222222456789");
			String card1=CipherUtil.decryptData("a698318900f5dca07ee9e2fb1527542e88553342399e6260","1232222222456789");
